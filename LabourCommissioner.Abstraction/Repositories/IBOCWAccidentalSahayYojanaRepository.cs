...
{
    public interface IBOCWAccidentalSahayYojanaRepository : IBaseRepository<TabModel>
    {
        ...
        Task<BOCWACSYSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId);
        Task<BOCWACSYSchemeDetails> GetTotalsahayByServiceID(int serviceId);
        Task<BOCWACSYSchemeDetails> GettotalsahaybysahayId(int serviceid, int deathdisability);
        ...
        Task<ResponseMessage> AddSchemeDetails(BOCWACSYSchemeDetails schemeDetails);
