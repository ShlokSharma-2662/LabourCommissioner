...
{
    public interface IBOCWAntyesthiYojanaRepository : IBaseRepository<TabModel>
    {
        ...
        Task<BOCWASYSchemeDetails> GetTotalsahayByServiceID(int serviceId);
        Task<BOCWASYSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId);
        ...
        Task<ResponseMessage> AddSchemeDetails(BOCWASYSchemeDetails schemeDetails);
