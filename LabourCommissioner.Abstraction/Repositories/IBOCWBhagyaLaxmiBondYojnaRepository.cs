...
{
    public interface IBOCWBhagyaLaxmiBondYojnaRepository : IBaseRepository<TabModel>
    {
        ...
        Task<BOCWBPSYSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId);
        Task<BOCWBPSYSchemeDetails> GettotalsahaybysahayId(int serviceid, int relation, int gender,int isApplied, int tharavId);
        ...
        Task<ResponseMessage> AddSchemeDetails(BOCWBPSYSchemeDetails schemeDetails);
