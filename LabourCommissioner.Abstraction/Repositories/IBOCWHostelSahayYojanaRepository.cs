...
{
    public interface IBOCWHostelSahayYojanaRepository : IBaseRepository<TabModel>
    {
        ...
        Task<BOCWHssySchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId);
        ...
        Task<ResponseMessage> AddSchemeDetails(BOCWHssySchemeDetails schemeDetails, DataTable dtFamilyData, DataTable dtChildrenData, DataTable dtChildrenHostelData);
