...
{
    public interface IBOCWNanajiYojanaRepository : IBaseRepository<TabModel>
    {
        ...
        Task<BOCWNanjiSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId);
        Task<BOCWNanjiSchemeDetails> GetTotalsahayByServiceID(int serviceId);
        ...
        Task<ResponseMessage> AddSchemeDetails(BOCWNanjiSchemeDetails schemeDetails, DataTable dt);
