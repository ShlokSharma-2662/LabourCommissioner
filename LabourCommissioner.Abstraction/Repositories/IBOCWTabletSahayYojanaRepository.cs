...
{
    public interface IBOCWTabletSahayYojanaRepository : IBaseRepository<TabModel>
    {
        ...
        Task<BOCWTSYSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId);
        ...
        Task<ResponseMessage> AddSchemeDetails(BOCWTSYSchemeDetails schemeDetails);
