...
{
    public interface IBOCWVYAVSHAYIKRepository : IBaseRepository<TabModel>
    {
        ...
        Task<BOCWVRSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId);
        ...
        Task<ResponseMessage> AddSchemeDetails(BOCWVRSchemeDetails schemeDetails, DataTable dtOtherSchemeData);
        ...
        Task<IEnumerable<SelectListItem>> GetDieases(long type);
    }
}