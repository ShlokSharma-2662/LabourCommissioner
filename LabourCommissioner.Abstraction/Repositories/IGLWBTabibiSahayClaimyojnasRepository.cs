...
{
    public interface IGLWBTabibiSahayClaimyojnasRepository : IBaseRepository<TabModel>
    {
        ...
        Task<GLWB_TSYClaim_personalDetails> GetCompanyDetailsByUserName(string UserName);
        Task<GLWB_TSYClaim_personalDetails> GetApplicationDetailsByAppId(long ApplicationId, string schemaname, string tablename);
       ...
       Task<GLWBTSYSchemeDetails> GetTotalsahayByServiceID(int serviceId);
        ...
        Task<GLWBTSYSchemeDetails> Glwb_Tsy_getapplicationschemedetailsbyappidclaim(long ApplicationId);
        ...
        Task<ResponseMessage> AddUpdateApplication(GLWB_TSYClaim_personalDetails personalDetailsModel);
