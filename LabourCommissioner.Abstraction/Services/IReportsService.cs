...
{
    public interface IReportsService : IBaseService<TabModel>
    {
        ...
        Task<List<FamilyMemberTravelDetails>> getrptbocw_hty_claim_familymembersschemedetails(long applicationId, string schemaName, string v);
    }
}