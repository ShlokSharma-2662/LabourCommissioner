...
{
    public partial class CMDAPIApplicationDetails : BaseDataTableEntity
    {
        public long serviceid { get; set; }
        public string servicename { get; set; }
        public long appyear { get; set; }
        public long appmonth { get; set; }
        public List<CMDAPIApplicationDetailsList> lstCMDAPIApplicationDetails { get; set; }
    }

    public class CMDAPIApplicationDetailsList
    {
