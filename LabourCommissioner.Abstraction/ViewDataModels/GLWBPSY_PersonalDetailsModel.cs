...
namespace LabourCommissioner.Abstraction.ViewDataModels
{
    ...
    public class GLWBPSY_PersonalDetailsModel
    {
        ...
        //[DataType(DataType.PhoneNumber)]
        //[RegularExpression(@"^\(?([0-9]{3})\)?[-. ]?([0-9]{3})[-. ]?([0-9]{4})$", ErrorMessage = "ફોન નંબર બરાબર નથી.")]
        //[Required(ErrorMessage = "ફોન નંબર લખો."), MaxLength(10)]
        public string? PhoneNo { get; set; }

        //[RequiredIf("isfilled", "false")]
        //[Required(ErrorMessage = "અરજદારનો ફોટો નાખો")]
       ...
       // public string ROutWordNo { get; set; }
        ...
        public string RegisteredAadharCardNo { get; set; }
