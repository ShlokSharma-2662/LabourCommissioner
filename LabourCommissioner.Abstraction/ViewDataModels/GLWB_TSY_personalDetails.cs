...
{
    public class GLWB_TSY_personalDetails
    {
       ...
       // public string GreenSoldierReferralcode { get; set; }
        ...
        [Required(ErrorMessage = "એચ.આર. મેનેજરશ્રી નું નામ લખો")]
        public string? hrManagerName { get; set; }

        [Required(ErrorMessage = "એચ.આર. મેનેજરશ્રી નો મોબાઇલ નંબર નાખો"), MaxLength(10)]
        public string? hrManagerMobile { get; set; }

        [Required(ErrorMessage = "એચ.આર. મેનેજરશ્રી નો ઈમેલ નાખો")]
        [RegularExpression("^[a-zA-Z0-9+_.-]+@[a-zA-Z0-9.-]+$", ErrorMessage = "ઈ-મેઈલ આઈડી બરાબર નથી.")]
        public string? hrManagerEmail { get; set; }

        [Required(ErrorMessage = "45 વર્ષથી ઉપરના પુરુષ ની સંખ્‍યા નાખો")]
        public int abovemale { get; set; }

        [Required(ErrorMessage = "45 વર્ષથી નીચેના પુરુષ ની સંખ્‍યા નાખો")]
        public int belowmale { get; set; }

        [Required(ErrorMessage = "35 વર્ષથી ઉપરની સ્ત્રી ની સંખ્‍યા નાખો")]
        public int abovefemale { get; set; }

        [Required(ErrorMessage = "35 વર્ષથી નીચેની સ્ત્રી ની સંખ્‍યા નાખો")]
        public int belowfemale { get; set; }

        [Required(ErrorMessage = "કુલ કર્મચારીઓ નાખો")]
        [Range(0, 10000000, ErrorMessage = "કૃપા કરીને 0 કરતા વધારે કર્મચારીઓ દાખલ કરો")]
