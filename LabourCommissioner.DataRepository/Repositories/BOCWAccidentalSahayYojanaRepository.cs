...
{
    public class BOCWAccidentalSahayYojanaRepository : BaseRepository<TabModel>, IBOCWAccidentalSahayYojanaRepository
    {
        public IConfiguration appConfig;
        public BOCWAccidentalSahayYojanaRepository(IConfiguration config) : base(config)
        {
        ...
        public async Task<BOCWACSYSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<BOCWACSYSchemeDetails>(Procedures.BOCW_ACSY_GetApplicationSchemeDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<BOCWACSYSchemeDetails> GetTotalsahayByServiceID(int serviceId)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    var result = (await conn.QueryAsync<BOCWACSYSchemeDetails>(Procedures.GetTotalsahayByServiceID, queryParameters, commandType: CommandType.StoredProcedure)).FirstOrDefault();
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<BOCWACSYSchemeDetails> GettotalsahaybysahayId(int serviceid, int deathdisability)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("_serviceid", serviceid);
                    queryParameters.Add("_relation", deathdisability);
                    queryParameters.Add("_gender", 0);
                    queryParameters.Add("_other1", 0);
                    queryParameters.Add("_tharavid", 0);
                    var result = (await conn.QueryAsync<BOCWACSYSchemeDetails>(Procedures.GetTotalsahayByServiceID, queryParameters, commandType: CommandType.StoredProcedure)).FirstOrDefault();
        ...
        public async Task<ResponseMessage> AddUpdateApplication(PersonalDetailsModel personalDetailsModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_acsy_insertpersonaldetails(@in_registrationid,@in_userprofileid,@in_photo,@in_name,@in_nameingujarati," +
                        ...
                        "@in_schemaname,@in_tablename,@in_applicationfrom,@in_shramikname,@in_shramikaadharcardno,@is_hasenirmancard,@out_error,@out_msg,@out_id,@out_applicatinno)";
        ...
        public async Task<ResponseMessage> AddSchemeDetails(BOCWACSYSchemeDetails schemeDetails)
        {
            ...
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_acsy_insertschemedetails(@in_applicationid,@in_serviceid,@in_userid,@in_sequenceno," +
                        "@in_relation,@in_deathdate,@in_deathtimeage,@in_createdby," +
                        "@in_isdeleted,@in_ipaddress,@in_hostname,@in_bankname,@in_bankbranch,@in_ifsccode,@in_bankaccountno," +
                        "@in_schemaname,@in_tablename,@in_address,@in_district,@in_pdistrictnameineng,@in_state,@in_taluka,@in_ptalukanameineng,@in_village,@in_pvillagenameineng,@in_pincode,@in_dateofaccident,@in_nomineename,@in_nomineeaadharcardno,@in_disabilitypercentage,@in_disabilitytypes,@in_deathplace,@in_deathdisability,@in_accountholdername,@in_totalsahay,@out_error,@out_msg,@out_id,@out_applicatinno)";
                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new DynamicParameters();
                    ...
                    queryParameters.Add("@in_dateofaccident", schemeDetails.dateofaccident);
                    ...
                    queryParameters.Add("@in_disabilitypercentage", schemeDetails.disabilitypercentage);
                    queryParameters.Add("@in_disabilitytypes", schemeDetails.disabilitytypes);
                    queryParameters.Add("@in_deathplace", schemeDetails.deathplace);
                    queryParameters.Add("@in_deathdisability", schemeDetails.deathdisability);
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetails(IList<DocumentFileDetails> lstdocumentFileDetails)
        {
            try
            {
                var procName = "CALL public.bocw_acsy_insertdocumentdetails(@in_applicationid,@in_documentmasterid,@in_documentname,@in_documentnumber,@in_createddate,@in_CreatedBy," +
                ...
                using (var conn = GetConnection())
                {
                    ...
                    foreach (var item in lstdocumentFileDetails)
                    {
                        ...
                        {
                            var procName1 = "CALL public.bocw_acsy_tabentry(@in_applicationid,@in_serviceid,@in_userid,@in_sequenceno)";
        ...
        public async Task<ResponseMessage> FinalSubmit(FinalSubmitModel finalSubmitModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_acsy_addupdateappdeclaration(@in_applicationid,@in_registrationid,@in_userid,@in_isagree,@in_ipaddress,@in_hostname," +
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetailsNew(DataTable dtData)    
        {
            ...
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_acsy_insertdocumentdetails_json(@in_documenttbl,@in_isupdated,@in_schemaname,@in_tablename,@out_error,@out_msg,@out_applicationid,@out_id)";
