...
{
    public class BOCWAntyesthiYojanaRepository : BaseRepository<TabModel>, IBOCWAntyesthiYojanaRepository
    {
        public IConfiguration appConfig;
        public BOCWAntyesthiYojanaRepository(IConfiguration config) : base(config)
        {
        ...
        public async Task<BOCWASYSchemeDetails> GetTotalsahayByServiceID(int serviceId)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    var result = (await conn.QueryAsync<BOCWASYSchemeDetails>(Procedures.GetTotalsahayByServiceID, queryParameters, commandType: CommandType.StoredProcedure)).FirstOrDefault();
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<BOCWASYSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId)
        {
           try
            {
                ...
                using (var conn = GetConnection())
               {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<BOCWASYSchemeDetails>(Procedures.BOCW_asy_GetApplicationSchemeDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<ResponseMessage> AddUpdateApplication(PersonalDetailsModel personalDetailsModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_asy_insertpersonaldetails(@in_registrationid,@in_userprofileid,@in_photo,@in_name,@in_nameingujarati," +
                        ...
                        "@in_schemaname,@in_tablename,@in_applicationfrom,@in_shramikname,@in_shramikaadharcardno,@is_hasenirmancard,@in_lalchopdino,@out_error,@out_msg,@out_id,@out_applicatinno)";
                    ...
                    queryParameters.Add("@in_shramikname", personalDetailsModel.ShramikName == null ? "" : personalDetailsModel.ShramikName);
                    queryParameters.Add("@in_shramikaadharcardno", personalDetailsModel.ShramikAadharCardNo == null ? "" : personalDetailsModel.ShramikAadharCardNo);
                    queryParameters.Add("@is_hasenirmancard", personalDetailsModel.HasENirmanCard);
                    queryParameters.Add("@in_lalchopdino", personalDetailsModel.LalChopdiNo);
        ...
        public async Task<ResponseMessage> AddSchemeDetails(BOCWASYSchemeDetails schemeDetails) 
        {
            ...
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_asy_insertschemedetails(@in_applicationid,@in_serviceid,@in_userid,@in_sequenceno," +
                        "@in_name,@in_Relation,@in_deathdate,@in_deathtimeage,@in_deathcertino,@in_mobileno,@in_email,@in_createdby," +
                        "@in_isdeleted,@in_ipaddress,@in_hostname,@in_bankname,@in_bankbranch,@in_ifsccode,@in_bankaccountno,@in_accountholdername,@in_totalsahay," +
                    ...
                    queryParameters.Add("@in_name", schemeDetails.name);
                    ...
                    queryParameters.Add("@in_deathcertino", schemeDetails.deathcertino);
                    queryParameters.Add("@in_mobileno", schemeDetails.mobileno);
                    queryParameters.Add("@in_email", schemeDetails.email);
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetails(IList<DocumentFileDetails> lstdocumentFileDetails)
        {
            try
            {
                var procName = "CALL public.bocw_asy_insertdocumentdetails(@in_applicationid,@in_documentmasterid,@in_documentname,@in_documentnumber,@in_createddate,@in_CreatedBy," +
                ...
                using (var conn = GetConnection())
                {
                    ...
                    foreach (var item in lstdocumentFileDetails)
                    {
                        ...
                        {
                            var procName1 = "CALL public.bocw_asy_tabentry(@in_applicationid,@in_serviceid,@in_userid,@in_sequenceno)";
        ...
        public async Task<ResponseMessage> FinalSubmit(FinalSubmitModel finalSubmitModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_asy_addupdateappdeclaration(@in_applicationid,@in_registrationid,@in_userid,@in_isagree,@in_ipaddress,@in_hostname," +
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetailsNew(DataTable dtData)
        {
            ...
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_asy_insertdocumentdetails_json(@in_documenttbl,@in_isupdated,@in_schemaname,@in_tablename,@out_error,@out_msg,@out_applicationid,@out_id)";
