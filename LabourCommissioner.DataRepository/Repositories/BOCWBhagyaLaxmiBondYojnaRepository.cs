...
{
    public class BOCWBhagyaLaxmiBondYojnaRepository : BaseRepository<TabModel>, IBOCWBhagyaLaxmiBondYojnaRepository
    {
        public IConfiguration appConfig;
        public BOCWBhagyaLaxmiBondYojnaRepository(IConfiguration config) : base(config)
        {
        ...
        public async Task<BOCWBPSYSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<BOCWBPSYSchemeDetails>(Procedures.BOCW_BPSY_GetApplicationSchemeDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
                ...
                using (var conn = GetConnection())
                 {
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("_serviceid", serviceid);
                    queryParameters.Add("_relation", relation);
                    queryParameters.Add("_gender", gender);
                    queryParameters.Add("_other1", isApplied);
                    queryParameters.Add("_tharavid", tharavId);

                    //var result = await conn.QueryFirstOrDefaultAsync<BOCWBPSYSchemeDetails>(Procedures.Get_BOCW_BPSY_TotalsahayByServiceID, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    var result = await conn.QueryFirstOrDefaultAsync<BOCWBPSYSchemeDetails>(Procedures.GetTotalsahayByServiceID, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                        return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<IEnumerable> GetBenifitByCourseId(int courseId)
        {
            try
            {
                ...
                {
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("_benifitsrs", courseId);
        ...
        public async Task<ResponseMessage> AddUpdateApplication(PersonalDetailsModel personalDetailsModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_bpsy_insertpersonaldetails(@in_registrationid,@in_userprofileid,@in_photo,@in_name,@in_nameingujarati," +
                        ...
                        "@in_sequenceno,@in_couchdbdocid,@in_couchdbdocrevid,@in_aadharcardno,@in_age,@in_pdistrictname,@in_ptalukaname,@in_pvillagename,@in_applicationno," +
                        "@in_serviceid,@in_schemaname,@in_tablename,@in_applicationfrom,@out_error,@out_msg,@out_id,@out_applicatinno)";
        ...
        public async Task<ResponseMessage> AddSchemeDetails(BOCWBPSYSchemeDetails schemeDetails)
        {
            ...
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_bpsy_insertschemedetails(@in_applicationid,@in_serviceid,@in_userid,@in_sequenceno,@in_expecteddeliverydate," +
                        "@in_prasutino,@in_age,@in_birthcertificateno,@in_gender,@in_birthcertificateissuedate,@in_kidsname,@in_nomineename,@in_relation,@in_createdby," +
                        "@in_isdeleted,@in_ipaddress,@in_hostname,@in_bankname,@in_bankbranch,@in_ifsccode,@in_bankaccountno,@in_accountholdername,@in_totalsahay,@in_schemaname,@in_tablename,@in_dateofbirth,@in_birthcertificateissuecompany," +
                        "@in_isalreadyapplied,@in_isbpsy,@out_error,@out_msg,@out_id,@out_applicatinno)";
                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new DynamicParameters();
                    ...
                    queryParameters.Add("@in_expecteddeliverydate", schemeDetails.ExpectedDeliveryDate);
                    queryParameters.Add("@in_prasutino", schemeDetails.PrasutiNo);
                    queryParameters.Add("@in_age", schemeDetails.Age);
                    queryParameters.Add("@in_birthcertificateno", schemeDetails.BirthCertificateNo);
                    queryParameters.Add("@in_gender", schemeDetails.Gender);
                    queryParameters.Add("@in_birthcertificateissuedate", schemeDetails.BirthCertificateIssueDate);
                    queryParameters.Add("@in_kidsname", schemeDetails.KidsName);
                    ...
                    queryParameters.Add("@in_dateofbirth", schemeDetails.PsDateOfBirth);
                    queryParameters.Add("@in_birthcertificateissuecompany", schemeDetails.BirthCertificateIssueCompany);
                    queryParameters.Add("@in_isalreadyapplied", schemeDetails.AlreadyApplied);
                    queryParameters.Add("@in_isbpsy", schemeDetails.IsBPSY);
                    queryParameters.Add("@out_error", 0, direction: ParameterDirection.InputOutput);
                    queryParameters.Add("@out_msg", "", direction: ParameterDirection.InputOutput);
                    queryParameters.Add("@out_id", 0, direction: ParameterDirection.InputOutput);
                    queryParameters.Add("@out_applicatinno", 0, direction: ParameterDirection.InputOutput);
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetails(IList<DocumentFileDetails> lstdocumentFileDetails)
        {
            try
            {
                var procName = "CALL public.bocw_bpsy_insertdocumentdetails(@in_applicationid,@in_documentmasterid,@in_documentname,@in_documentnumber,@in_createddate,@in_CreatedBy," +
        ...
        public async Task<ResponseMessage> FinalSubmit(FinalSubmitModel finalSubmitModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_bpsy_addupdateappdeclaration(@in_applicationid,@in_registrationid,@in_userid,@in_isagree,@in_ipaddress,@in_hostname," +
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetailsNew(DataTable dtData)    
        {
            ...
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_bpsy_insertdocumentdetails_json(@in_documenttbl,@in_isupdated,@in_schemaname,@in_tablename,@out_error,@out_msg,@out_applicationid,@out_id)";
