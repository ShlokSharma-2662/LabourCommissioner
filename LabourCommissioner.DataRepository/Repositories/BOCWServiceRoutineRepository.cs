...
{
    public class BOCWServiceRoutineRepository : BaseRepository<Registration>, IBOCWServiceRoutineRepository
    {
        public IConfiguration appConfig;
        private readonly UserCookies cookies;
        private readonly ClaimsPrincipal _claimPincipal;
        public BOCWServiceRoutineRepository(IConfiguration config, IHttpContextAccessor _httpContextAccessor) : base(config)
        {
