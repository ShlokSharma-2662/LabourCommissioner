    ...
    public class BOCWSikshanSahayYojanaRepository : BaseRepository<TabModel>, IBOCWSikshanSahayYojanaRepository
    {
        ...
        public async Task<PersonalDetailsModelAPI> GetPersonalDetailsByRegNoAPI(string RegistrationNo)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<PersonalDetailsModelAPI>(Procedures.GetPersonalDetailsByRegNo, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<PersonalDetailsModelAPI> GetApplicationDetailsByAppIdAPI(long ApplicationId, string schemaname, string tablename)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<PersonalDetailsModelAPI>(Procedures.GetApplicationDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<SchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<SchemeDetails>(Procedures.GetApplicationSchemeDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
            ...
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_ssy_insertschemedetails(@in_applicationid,@in_serviceid,@in_userid,@in_sequenceno,@in_schmename," +
                        "@in_syllabus,@in_course,@in_acadmicyearsem,@in_startdate,@in_schoolcollagename,@in_benifitsrs,@in_hostelbenifits,@in_booksbenifits,@in_ubenifitsrs,@in_uhostelbenifits,@in_ubooksbenifits,@in_fbenifitsrs,@in_fhostelbenifits,@in_fbooksbenifits,@in_totalsahay,@in_createdby," +
                    ...
                    queryParameters.Add("@in_benifitsrs", schemeDetails.benifitsrs);
                    queryParameters.Add("@in_hostelbenifits", schemeDetails.hostelbenifits);
                    queryParameters.Add("@in_booksbenifits", schemeDetails.booksbenifits);
                    queryParameters.Add("@in_ubenifitsrs", schemeDetails.ubenifitsrs);
                    queryParameters.Add("@in_uhostelbenifits", schemeDetails.uhostelbenifits);
                    queryParameters.Add("@in_ubooksbenifits", schemeDetails.ubooksbenifits);
                    queryParameters.Add("@in_fbenifitsrs", schemeDetails.fbenifitsrs);
                    queryParameters.Add("@in_fhostelbenifits", schemeDetails.fhostelbenifits);
                    queryParameters.Add("@in_fbooksbenifits", schemeDetails.fbooksbenifits);
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetailsNew(DataTable dtData)    
        {
            ...
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_ssy_insertdocumentdetails_json(@in_documenttbl,@in_isupdated,@in_schemaname,@in_tablename,@out_error,@out_msg,@out_applicationid,@out_id)";
