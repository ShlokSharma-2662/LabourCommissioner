...
{
    public class BOCWTabibiSahayYojanaClaimRepository : BaseRepository<TabModel>, IBOCWTabibiSahayYojanaClaimRepository
    {
        public IConfiguration appConfig;
        public BOCWTabibiSahayYojanaClaimRepository(IConfiguration config) : base(config)
        {
        ...
        public async Task<BOCW_TBSYClaim_personalDetails> GetPersonalDetailsByRegNo(string RegistrationNo)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<BOCW_TBSYClaim_personalDetails>(Procedures.GetPersonalDetailsByRegNo, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<BOCW_TBSYClaim_personalDetails> GetApplicationDetailsByAppId(long ApplicationId, string schemaname, string tablename)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<BOCW_TBSYClaim_personalDetails>(Procedures.GetBocw_Tbsy_Claim_ApplicationDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<IEnumerable<BOCW_TBSYClaim_personalDetails>> GetCheckedUPApplicationDetailsByServiceId(long serviceid, string schemaname, string tablename)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    queryParameters.Add("in_tblname", tablename);
                    queryParameters.Add("in_schemaname", schemaname);
                    var result = (await conn.QueryAsync<BOCW_TBSYClaim_personalDetails>(Procedures.getbocw_tbsyapplicationforhospital, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<BOCWTBSYSchemeDetails> GetTotalsahayByServiceID(int serviceId)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    var result = (await conn.QueryAsync<BOCWTBSYSchemeDetails>(Procedures.GetTotalsahayByServiceID, queryParameters, commandType: CommandType.StoredProcedure)).FirstOrDefault();
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<BOCWTBSYSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<BOCWTBSYSchemeDetails>(Procedures.BOCW_tbsy_GetApplicationSchemeDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<BOCW_TBSYClaim_personalDetails> GetCompanyDetailsByUserName(string UserName)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<BOCW_TBSYClaim_personalDetails>(Procedures.GetHospitalDetailsByUserName, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<ResponseMessage> AddUpdateApplication(BOCW_TBSYClaim_personalDetails personalDetailsModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_tbsy_claim_insertpersonaldetails(@in_registrationid,@in_userprofileid," +
                        "@in_hospitalname,@in_hospitalemailid,@in_hospitaladdress," +
                        "@in_hospitalmobile,@in_hospitalpincode,@in_bankname,@in_bankbranch,@in_ifsccode,@in_bankaccountno,@in_accountholdername," +
                    ...
                    queryParameters.Add("@in_accountholdername", personalDetailsModel.AccountHolderName);
        ...
        public async Task<ResponseMessage> AddSchemeDetails(DataTable dtData)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_tbsy_insertschemedetails_json(@in_documenttbl,@in_isupdated,@in_schemaname,@in_tablename,@out_error,@out_msg,@out_applicationid,@out_id)";
                    ...
                    queryParameters.Add("@in_schemaname", Convert.ToString(dtData.Rows[0]["schemaname"]) == null || Convert.ToString(dtData.Rows[0]["schemaname"]) == "" ? nameof(EnumLookup.schemaname.bocw_tbsy_claim) : Convert.ToString(dtData.Rows[0]["schemaname"]));
                    queryParameters.Add("@in_tablename", Convert.ToString(dtData.Rows[0]["tablename"]) == null || Convert.ToString(dtData.Rows[0]["tablename"]) == "" ? nameof(EnumLookup.tablename.tabentry) : Convert.ToString(dtData.Rows[0]["tablename"]));
                    queryParameters.Add("@out_error", 0, direction: ParameterDirection.InputOutput);
                    queryParameters.Add("@out_msg", "", direction: ParameterDirection.InputOutput);
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetails(IList<DocumentFileDetails> lstdocumentFileDetails)
        {
            try
            {
                var procName = "CALL public.bocw_tbsy_insertdocumentdetails(@in_applicationid,@in_documentmasterid,@in_documentname,@in_documentnumber,@in_createddate,@in_CreatedBy," +
                ...
                using (var conn = GetConnection())
                {
                    ...
                    foreach (var item in lstdocumentFileDetails)
                    {
                        ...
                        {
                            var procName1 = "CALL public.bocw_tbsy_tabentry(@in_applicationid,@in_serviceid,@in_userid,@in_sequenceno)";
        ...
        public async Task<ResponseMessage> FinalSubmit(FinalSubmitModel finalSubmitModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_tbsy_claim_addupdateappdeclaration(@in_applicationid,@in_registrationid,@in_userid,@in_isagree,@in_ipaddress,@in_hostname," +
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetailsNew(DataTable dtData)
        {
            ...
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.bocw_tbsy_claim_insertdocumentdetails_json(@in_documenttbl,@in_isupdated,@in_schemaname,@in_tablename,@out_error,@out_msg,@out_applicationid,@out_id)";
        ...
        public Task<ResponseMessage> AddSchemeDetails(BOCWTBSYSchemeDetails schemeDetails)
        {
            throw new NotImplementedException();
        }

        public Task<ResponseMessage> AddSchemeDetails(BOCW_TBSYClaim_personalDetails schemeDetails)
        {
            throw new NotImplementedException();
        }
        ...
        //        using (var conn = GetConnection())
        //        {
        //            var procName = "CALL public.bocw_tbsy_insertschemedetails(@in_applicationid,@in_serviceid,@in_userid,@in_sequenceno," +
        //                "@in_testname,@in_testno,@in_testdetails,@in_totalsahay,@in_createdby," +
        //                "@in_isdeleted,@in_ipaddress,@in_hostname," +
        //                "@in_schemaname,@in_tablename,@out_error,@out_msg,@out_id,@out_applicatinno)";
        //            ResponseMessage res = new ResponseMessage();
        //            var queryParameters = new DynamicParameters();
        ...
        //            queryParameters.Add("@in_testname", schemeDetails.testname);
        //            queryParameters.Add("@in_testno", schemeDetails.testno);
        //            queryParameters.Add("@in_testdetails", schemeDetails.testdetails);
        ...
        //public async Task<ResponseMessage> AddSchemeDetails(BOCW_TBSYClaim_personalDetails schemeDetails)
        //{
