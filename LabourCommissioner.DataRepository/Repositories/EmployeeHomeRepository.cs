...
{
    public class EmployeeHomeRepository : BaseRepository<Registration>, IEmployeeHomeRepository
    {
        public IConfiguration appConfig;
        private readonly UserCookies cookies;
        private readonly ClaimsPrincipal _claimPincipal;
        public EmployeeHomeRepository(IConfiguration config, IHttpContextAccessor _httpContextAccessor) : base(config)
        {
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> BOCW_SSY_GetApplicationDetailsList(int? pageNo, int pageSize, long districtId, long talukaId, long villageId, DateTime? fromDate,
            DateTime? toDate, int statusId, string? search, long postId, long serviceid, string? action, string? schemaName, long subServiceId, long isbpsyservice)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    queryParameters.Add("@in_isbpsyservice", isbpsyservice);
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> GLWB_Hospital_GetApplicationDetailsList(int? pageNo, int pageSize, long divisionId, DateTime? fromDate,
            DateTime? toDate, int statusId, string? search, long postId, long serviceid, string? action, string? schemaName)
        {
            try
            {
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> GLWBHospitalApplicationDetailsClaim(int? pageNo, int pageSize, long divisionId, DateTime? fromDate,
           DateTime? toDate, int statusId, string? search, long postId, long serviceid, string? action, string? schemaName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    queryParameters.Add("@in_action", action);
                    queryParameters.Add("@in_schemaname", schemaName);
                    var result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.GLWBHospitalApplicationDetailsClaim, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    // var result = (await conn.QueryFirstOrDefaultAsync<ApplicationFilterModel>(Procedures.BOCW_SSY_GetApplicationDetailsList, queryParameters, commandType: System.Data.CommandType.StoredProcedure));
                    return result;
                }
            }
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> GetGlwb_TsyUploadedDocumentForEmployee(int applicationId, int serviceId, string schemaName, string tableName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    queryParameters.Add("@in_schemaname", schemaName);
                    queryParameters.Add("@in_tablename", tableName);
                    var result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.GetGlwb_TsyUploadedDocumentForEmployee, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception e)
        ...
        public async Task<EmpApplicationDetailsModel> ApproveApplication(string applicationId, string approvalstate, int toroleid, string approvalstatus, string remarks, string fromPostId, string serviceId, string topostid, string schemaname, string tablename, int beneficiarytype)
        {
            try
            {
                ...
                {
                    var procName = "";
                    if (serviceId == "32" || serviceId == "34")
                    {
                        procName = "CALL public.glwb_hty_addapprovaldetails(@in_applicationid,@in_approvalstate,@in_toroleid,@in_applicationstatus,@in_remarks," +
                    ...
                    {
                        procName = "CALL public.addapprovaldetails(@in_applicationid,@in_approvalstate,@in_toroleid,@in_applicationstatus,@in_remarks," +
                       "@in_createdbypostid,@in_createdbyempid,@in_serviceid,@in_topostid,@in_schemaname,@in_tablename,@in_beneficiarytype," +
                       "@out_error,@out_issendmail,@out_applicantname,@out_msg,@out_approvalid,@out_email,@out_mobileno)";
                    }
        ...
        public async Task<ResponseMessage> TimeScheduleHospital(HospitalScheduleTime hospitalScheduleTime)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.addhospitaltime(@in_applicationno,@in_applicationid,@in_fromdate,@in_todate,@in_fromtime,@in_totime," +
                        "@in_ipaddress,@in_hostname,@in_createddate,@in_isdeleted,@in_serviceid,@out_msg, @out_applicationname, @out_email)";

                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new Dapper.DynamicParameters();
                    queryParameters.Add("@in_applicationno", hospitalScheduleTime.ApplicationNo);
                    queryParameters.Add("@in_applicationid", hospitalScheduleTime.ApplicationId);
                    queryParameters.Add("@in_fromdate", hospitalScheduleTime.fromdate);
                    queryParameters.Add("@in_todate", hospitalScheduleTime.todate);
                    queryParameters.Add("@in_fromtime", hospitalScheduleTime.fromtime);
                    queryParameters.Add("@in_totime", hospitalScheduleTime.totime);
                    queryParameters.Add("@in_ipaddress", hospitalScheduleTime.IpAddress);
                    queryParameters.Add("@in_hostname", hospitalScheduleTime.HostName);
                    queryParameters.Add("@in_createddate", hospitalScheduleTime.CreatedDate);
                    queryParameters.Add("@in_isdeleted", hospitalScheduleTime.IsDeleted);
                    queryParameters.Add("@in_serviceid", hospitalScheduleTime.ServiceId);
                    queryParameters.Add("@out_msg", "", direction: ParameterDirection.InputOutput);
                    queryParameters.Add("@out_email", "", direction: ParameterDirection.InputOutput);
        ...
        public async Task<ResponseMessage> UploadUserApplicationReport(HospitalScheduleTime hospitalScheduleTime)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.uploadapplicationreport(@in_applicationno,@in_applicationid,@in_filename,@in_couchdbid,@in_couchdbrevid,@in_remarks," +
                        "@in_ipaddress,@in_hostname,@in_isdeleted,@in_serviceid,@out_msg, @out_applicationname, @out_email)";

                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new Dapper.DynamicParameters();
                    queryParameters.Add("@in_applicationno", hospitalScheduleTime.ApplicationNo);
                    queryParameters.Add("@in_applicationid", hospitalScheduleTime.ApplicationId);
                    queryParameters.Add("@in_filename", hospitalScheduleTime.DocumentName);
                    queryParameters.Add("@in_couchdbid", hospitalScheduleTime.CouchDBDocId);
                    queryParameters.Add("@in_couchdbrevid", hospitalScheduleTime.CouchDBDocRevId);
                    queryParameters.Add("@in_remarks", hospitalScheduleTime.Remarks);
                    queryParameters.Add("@in_ipaddress", hospitalScheduleTime.IpAddress);
                    queryParameters.Add("@in_hostname", hospitalScheduleTime.HostName);
                    queryParameters.Add("@in_isdeleted", hospitalScheduleTime.IsDeleted);
                    queryParameters.Add("@in_serviceid", hospitalScheduleTime.ServiceId);
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> ApproveMultipleApplication(string applicationId, string approvalstate, int toroleid, string approvalstatus, string remarks, string fromPostId, string serviceId, string topostid, string schemaname, string tablename, int beneficiarytype, DataTable dtApplicationIds, string ipAddress, string hostName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    EmpApplicationDetailsModel res = new EmpApplicationDetailsModel();
                    List<EmpApplicationDetailsModel> result = new List<EmpApplicationDetailsModel>();
                    var queryParameters = new Dapper.DynamicParameters();
                    ...
                    //res.mobileno = queryParameters.Get<string>("@out_mobileno");
                    //res.Id = queryParameters.Get<long>("@out_approvalid");
                    if (Convert.ToInt64(serviceId) == 32 || Convert.ToInt64(serviceId) == 34)
                    {
                        result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.GLWB_HTY_AddMultipleApprovalDetails, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    }
                    else if (Convert.ToInt64(serviceId) != 36)
                    {
                        result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.AddMultipleApprovalDetails, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    }
                    else
                    {
                        result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.bocw_tbsy_claim_addmultipleapprovaldetails, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    }
        ...
        public async Task<IEnumerable<SelectListItem>> GetSendBackRoleGLWb_TSY(int serviceid, int postid, long districtid, long aplicationid, string schemaName, int beneficiarytype)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    queryParameters.Add("_schemaname", schemaName);
                    queryParameters.Add("_beneficiarytype", beneficiarytype);
                    var result = (await conn.QueryAsync<SelectListItem>(Procedures.GetSendBackRoleGLWb_TSY, queryParameters, commandType: CommandType.StoredProcedure));
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> GetApplicationHistory_Glwb_Tsy_claim(long applicationid, string schemaName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    queryParameters.Add("@in_applicationid", applicationid);
                    queryParameters.Add("@in_schemaname", schemaName);
                    var result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.GetApplicationHistory_Glwb_Tsy_claim, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception e)
        ...
        public async Task<IEnumerable<HospitalScheduleTime>> GetHospitalScheduleTime(long applicationid, long serviceid)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    queryParameters.Add("@in_applicationid", applicationid);
                    queryParameters.Add("@in_serviceid", serviceid);
                    var result = (await conn.QueryAsync<HospitalScheduleTime>(Procedures.GetHospitalScheduleTime, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception e)
        ...
        public async Task<IEnumerable<CountForDashBoard>> BindCountForDashboardGLWB_tsy(long finYear, long districtId, long postId, long serviceId)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    queryParameters.Add("in_postid", postId);
                    queryParameters.Add("in_serviceid", serviceId);
                    var result = (await conn.QueryAsync<CountForDashBoard>(Procedures.BindCountForDashboardGLWB_tsy, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<ResponseMessage> DeleteRegistration(long registrationId, long userId, long beneficiaryTypeId, string ipAddress, string hostName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.deleteregistration(@in_registrationid,@in_userid,@in_beneficiarytypeid,@in_ipaddress,@in_hostname,@out_error,@out_msg,@out_id)";
                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("@in_registrationid", registrationId);
                    queryParameters.Add("@in_userid", userId);
                    ...
                    res.Msg = queryParameters.Get<string>("@out_msg");
                    res.Error = queryParameters.Get<Int64>("@out_error");
                    res.Id = queryParameters.Get<Int64>("@out_id");
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> Glwb_Tsy_ViewAadeshDetails(int? pageNo, int pageSize, DateTime? fromDate, DateTime? toDate, int statusId, string? search, long serviceid, string? schemaName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    var result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.Glwb_Tsy_ViewAadeshDetails, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception e)
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> GetGlwbTSYAadeshDetailsbyAadeshid(long aadeshId, string? schemaName, long applicationId)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    var result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.GetGlwbTSYAadeshDetailsbyAadeshid, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception e)
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> GLWBSendForPayment(DataTable dtAadeshIds, long serviceId, string schemaName, long postId, string ipAddress, string hostName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    queryParameters.Add("@in_ipaddress", ipAddress);
                    queryParameters.Add("@in_hostname", hostName);
                    var result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.GLWBSendForPayment, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<IEnumerable<PaymentDetailsModel>> GetGLWBPaymentHistory(int? pageNo, int pageSize, DateTime? fromDate, DateTime? toDate, string? search, long serviceid, int statusId)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    var result = (await conn.QueryAsync<PaymentDetailsModel>(Procedures.GetGLWBPaymentHistory, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception e)
        ...
        public async Task<ResponseMessage> UpdateBOCWBankDetails(long applicationId, long serviceId, string? bankaccountNo, string? IFSCCode, string Remarks, long userId, string? schemaName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.updatebocwbankdetails(@in_applicationid,@in_serviceid,@in_bankaccountno,@in_ifsccode,@in_remarks,@in_userid,@in_schemaname,@out_error,@out_msg,@out_data)";
                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("@in_applicationid", applicationId);
                    queryParameters.Add("@in_serviceid", serviceId);
                    queryParameters.Add("@in_bankaccountno", bankaccountNo);
                    queryParameters.Add("@in_ifsccode", IFSCCode);
                    queryParameters.Add("@in_remarks", Remarks);
                    queryParameters.Add("@in_userid", userId);
                    queryParameters.Add("@in_schemaname", schemaName);
                    queryParameters.Add("@out_error", 0, direction: ParameterDirection.InputOutput);
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> BOCWSendForPaymentFailedRecord(DataTable dtPayInfoIds, long serviceId, string schemaName, long postId, string ipAddress, string hostName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    EmpApplicationDetailsModel res = new EmpApplicationDetailsModel();
                    var queryParameters = new Dapper.DynamicParameters();
                    queryParameters.Add("@in_applicationtbl", new JsonParameter(JsonConvert.SerializeObject(dtPayInfoIds)));
                    queryParameters.Add("@in_serviceid", serviceId);
                    queryParameters.Add("@in_schemaname", Convert.ToString(schemaName));
                    queryParameters.Add("@in_postid", Convert.ToInt64(postId));
                    queryParameters.Add("@in_ipaddress", ipAddress);
                    queryParameters.Add("@in_hostname", hostName);
                    var result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.BOCWSendForPaymentFailedRecord, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<ResponseMessage> UpdateGLWBBankDetails(long applicationId, long serviceId, string? bankaccountNo, string? IFSCCode, string Remarks, long userId, string? schemaName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.updateglwbbankdetails(@in_applicationid,@in_serviceid,@in_bankaccountno,@in_ifsccode,@in_remarks,@in_userid,@in_schemaname,@out_error,@out_msg,@out_data)";
                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("@in_applicationid", applicationId);
                    queryParameters.Add("@in_serviceid", serviceId);
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> GLWBSendForPaymentFailedRecord(DataTable dtPayInfoIds, long serviceId, string schemaName, long postId, string ipAddress, string hostName)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    queryParameters.Add("@in_ipaddress", ipAddress);
                    queryParameters.Add("@in_hostname", hostName);
                    var result = (await conn.QueryAsync<EmpApplicationDetailsModel>(Procedures.GLWBSendForPaymentFailedRecord, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<HospitalScheduleTime> gethospitaluploadeddocumentsbyappid(long applicationid)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("@in_applicationid", applicationid);
                    var result = await conn.QueryFirstOrDefaultAsync<HospitalScheduleTime>(Procedures.gethospitaluploadeddocumentsbyappid, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception e)
