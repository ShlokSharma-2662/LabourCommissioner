...
{
    public class GLWBHomeLoanSubsidyYojanaRepository : BaseRepository<TabModel>, IGLWBHomeLoanSubsidyYojanaRepository
    {
        public IConfiguration appConfig;
        public GLWBHomeLoanSubsidyYojanaRepository(IConfiguration config) : base(config)
        {
        ...
        public async Task<GLWBHLS_PersonalDetailsModel> GetPersonalDetailsByRegNo(string RegistrationNo)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<GLWBHLS_PersonalDetailsModel>(Procedures.GetPersonalDetailsByRegNo, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<GLWBHLS_PersonalDetailsModel> GetApplicationDetailsByAppId(long ApplicationId, string schemaname, string tablename)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<GLWBHLS_PersonalDetailsModel>(Procedures.GLWB_GetApplicationDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<GLWBHLS_SchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("in_applicationid", ApplicationId);
                    var result = await conn.QueryFirstOrDefaultAsync<GLWBHLS_SchemeDetails>(Procedures.GLWB_HLS_Getschemedetails, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<ResponseMessage> AddUpdateApplication(GLWBHLS_PersonalDetailsModel personalDetailsModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_hls_insertpersonaldetails(@in_registrationid,@in_userprofileid,@in_photo,@in_name,@in_nameingujarati," +
        ...
        public async Task<ResponseMessage> AddSchemeDetails(GLWBHLS_SchemeDetails schemeDetails)
        {
            ...
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_hls_insertschemedetails(@in_applicationid, @in_serviceid, @in_userid, @in_sequenceno," +
                        "@in_createdby, @in_isdeleted, @in_ipaddress, @in_hostname, @in_monthlyincome, @in_houseprice," +
                        "@in_doucumentnumber, @in_doucumentdate, @in_loanamount, @in_loanduration, @in_installmentamount, @in_intrestrate, " +
                        "@in_loanapprovaldate, @in_loanaccountno, @in_bankname, @in_bankbranch, @in_ifsccode ,@in_bankaccountno, @in_totalsahay,@in_schemaname, @in_tablename," +
                        "@out_error,@out_msg,@out_id,@out_applicatinno)";
                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new DynamicParameters();
                   // queryParameters.Add("@in_schemeid", schemeDetails.SchemeId);
                    ...
                    queryParameters.Add("@in_monthlyincome", schemeDetails.monthlyincome);
                    queryParameters.Add("@in_houseprice", schemeDetails.houseprice);
                    queryParameters.Add("@in_doucumentnumber", schemeDetails.doucumentnumber);
                    queryParameters.Add("@in_doucumentdate", schemeDetails.doucumentdate);
                    queryParameters.Add("@in_loanamount", schemeDetails.loanamount);
                    queryParameters.Add("@in_loanduration", schemeDetails.loanduration);
                    queryParameters.Add("@in_installmentamount", schemeDetails.installmentamount);
                    queryParameters.Add("@in_intrestrate", schemeDetails.intrestrate);
                    queryParameters.Add("@in_loanapprovaldate", schemeDetails.loanapprovaldate);
                    queryParameters.Add("@in_loanaccountno", schemeDetails.loanaccountno);
        ...
        public async Task<ResponseMessage> FinalSubmit(FinalSubmitModel finalSubmitModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_hls_addupdateappdeclaration(@in_applicationid,@in_registrationid,@in_userid,@in_isagree,@in_ipaddress,@in_hostname," +
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetailsNew(DataTable dtData)    
        {
            ...
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_hls_insertdocumentdetails_json(@in_documenttbl,@in_isupdated,@in_schemaname,@in_tablename,@out_error,@out_msg,@out_applicationid,@out_id)";
                    ...
                    queryParameters.Add("@in_schemaname", nameof(EnumLookup.schemaname.glwb_hls));
