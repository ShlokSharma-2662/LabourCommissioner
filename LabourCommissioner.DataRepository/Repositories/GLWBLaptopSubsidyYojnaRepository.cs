...
{
    public class GLWBLaptopSubsidyYojnaRepository : BaseRepository<TabModel>, IGLWBLaptopSubsidyYojnaRepository
    {
        public IConfiguration appConfig;
        public GLWBLaptopSubsidyYojnaRepository(IConfiguration config) : base(config)
        {
        ...
        public async Task<GLWBLSY_PersonalDetails> GetPersonalDetailsByRegNo(string RegistrationNo)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<GLWBLSY_PersonalDetails>(Procedures.GetPersonalDetailsByRegNo, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<GLWBLSY_PersonalDetails> GetApplicationDetailsByAppId(long ApplicationId, string schemaname, string tablename)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<GLWBLSY_PersonalDetails>(Procedures.GLWB_GetApplicationDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<GLWBLSY_SchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("in_applicationid", ApplicationId);
                    var result = await conn.QueryFirstOrDefaultAsync<GLWBLSY_SchemeDetails>(Procedures.GLWBLSY_GetApplicationSchemeDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<ResponseMessage> AddUpdateApplication(GLWBLSY_PersonalDetails personalDetailsModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_lsy_insertpersonaldetails(@in_registrationid,@in_userprofileid,@in_photo,@in_name,@in_nameingujarati," +
        ...
        public async Task<ResponseMessage> AddSchemeDetails(GLWBLSY_SchemeDetails schemeDetails)
        {
            ...
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_lsy_insertschemedetails(@in_applicationid,@in_serviceid,@in_userid,@in_sequenceno," +
                        "@in_courseid,@in_percentage,@in_examyear,@in_exammonth,@in_coursename,@in_university,@in_buydate," +
                        "@in_billno,@in_laptopamount,@in_laptopserialno,@in_laptopbrand,@in_enirmancardno,@in_createdby," +
                        "@in_isdeleted,@in_ipaddress,@in_hostname,@in_bankname,@in_bankbranch," +
                        "@in_ifsccode,@in_bankaccountno,@in_totalsahay,@in_schemaname,@in_tablename," +
                        "@out_error,@out_msg,@out_id,@out_applicatinno)";
                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new DynamicParameters();
                    ...
                    //queryParameters.Add("@in_mdate", schemeDetails.mdate);    
                    //queryParameters.Add("@in_mnum", schemeDetails.mnum);
                    //queryParameters.Add("@in_ysalary", schemeDetails.ysalary);
                    queryParameters.Add("@in_courseid", schemeDetails.courseid);
                    queryParameters.Add("@in_percentage", schemeDetails.Percentage);
                    queryParameters.Add("@in_examyear", schemeDetails.ExamYear);
                    queryParameters.Add("@in_exammonth", schemeDetails.ExamMonth);
                    queryParameters.Add("@in_coursename", schemeDetails.coursename);
                    queryParameters.Add("@in_university", schemeDetails.university);
                    queryParameters.Add("@in_buydate", schemeDetails.buydate);
                    queryParameters.Add("@in_billno", schemeDetails.billno);
                    queryParameters.Add("@in_laptopamount", schemeDetails.laptopamount);
                    queryParameters.Add("@in_laptopserialno", schemeDetails.laptopserialno);
                    queryParameters.Add("@in_laptopbrand", schemeDetails.laptopbrand);
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetails(IList<DocumentFileDetails> lstdocumentFileDetails)
        {
            try
            {
                var procName = "CALL public.glwb_lsy_insertdocumentdetails(@in_applicationid,@in_documentmasterid,@in_documentname,@in_documentnumber,@in_createddate,@in_CreatedBy," +
        ...
        public async Task<ResponseMessage> FinalSubmit(FinalSubmitModel finalSubmitModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_lsy_addupdateappdeclaration(@in_applicationid,@in_registrationid,@in_userid,@in_isagree,@in_ipaddress,@in_hostname," +
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetailsNew(DataTable dtData)
        {
            ...
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_lsy_insertdocumentdetails_json(@in_documenttbl,@in_isupdated,@in_schemaname,@in_tablename,@out_error,@out_msg,@out_applicationid,@out_id)";
                    ...
                    queryParameters.Add("@in_schemaname", nameof(EnumLookup.schemaname.glwb_lsy));
