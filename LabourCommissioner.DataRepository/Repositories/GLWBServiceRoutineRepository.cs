...
{
    public class GLWBServiceRoutineRepository : BaseRepository<Registration>, IGLWBServiceRoutineRepository
    {
        public IConfiguration appConfig;
        private readonly UserCookies cookies;
        private readonly ClaimsPrincipal _claimPincipal;
        public GLWBServiceRoutineRepository(IConfiguration config, IHttpContextAccessor _httpContextAccessor) : base(config)
        {
