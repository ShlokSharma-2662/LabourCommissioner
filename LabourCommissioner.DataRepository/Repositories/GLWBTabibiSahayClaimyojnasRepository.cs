...
{
    public class GLWBTabibiSahayClaimyojnasRepository : BaseRepository<TabModel>, IGLWBTabibiSahayClaimyojnasRepository
    {
        public IConfiguration appConfig;
        public GLWBTabibiSahayClaimyojnasRepository(IConfiguration config) : base(config)
        {
        ...
        public async Task<GLWB_TSY_personalDetails> GetPersonalDetailsByRegNo(string RegistrationNo)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<GLWB_TSY_personalDetails>(Procedures.GetPersonalDetailsByRegNo, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<GLWB_TSYClaim_personalDetails> GetCompanyDetailsByUserName(string UserName)
        {
            try
            {
                ...
                {
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("_username", UserName);

                    var result = await conn.QueryFirstOrDefaultAsync<GLWB_TSYClaim_personalDetails>(Procedures.GetCompanyDetailsByUserName, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<GLWB_TSYClaim_personalDetails> GetApplicationDetailsByAppId(long ApplicationId, string schemaname, string tablename)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<GLWB_TSYClaim_personalDetails>(Procedures.GLWB_TSY_Claim_GetApplicationDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<GLWBTSYSchemeDetails> GetTotalsahayByServiceID(int serviceId)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    ...
                    var result = (await conn.QueryAsync<GLWBTSYSchemeDetails>(Procedures.GetTotalsahayByServiceID, queryParameters, commandType: CommandType.StoredProcedure)).FirstOrDefault();
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<GLWBTSYSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    GLWBTSYSchemeDetails objGLWBTSYSchemeDetails = new GLWBTSYSchemeDetails();
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("in_applicationid", ApplicationId);
                    var result = (await conn.QueryAsync<GLWBTSYSchemeDetails>(Procedures.glwb_tsy_claim_GetApplicationSchemeDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    if (result != null && result.Count() > 0)
                    {


                        objGLWBTSYSchemeDetails.BankAccountNo = result.Select(x => x.BankAccountNo).FirstOrDefault();
                        objGLWBTSYSchemeDetails.BankBranch = result.Select(x => x.BankBranch).FirstOrDefault();
                        objGLWBTSYSchemeDetails.BankName = result.Select(x => x.BankName).FirstOrDefault();
                        objGLWBTSYSchemeDetails.IFSCCode = result.Select(x => x.IFSCCode).FirstOrDefault();
                        objGLWBTSYSchemeDetails.lwbaccountno = result.Select(x => x.lwbaccountno).FirstOrDefault();
                        objGLWBTSYSchemeDetails.totalsahay = result.Select(x => x.totalsahay).FirstOrDefault();
                        objGLWBTSYSchemeDetails.finaltotalsahay = result.Select(x => x.finaltotalsahay).FirstOrDefault();
                        objGLWBTSYSchemeDetails.remarks = result.Select(x => x.remarks).FirstOrDefault();

                        objGLWBTSYSchemeDetails.lstCompanyWorkerDetails = result.Select(m => new CompanyWorkerDetails
                        {
                            workerdetailsid = m.fg_workerdetailsid,
                            registrationid = m.fg_registrationid,
                            //workername = m.fg_workername,
                            gender = m.fg_gender,
                            DateOfBirth = m.fg_DateOfBirth,
                            ageyear = m.fg_ageyear,
                            sanmanregistrationno = m.fg_sanmanregistrationno,
                            ischeckeup = m.fg_ischeckup,
                        }).ToList();
                    ...
                    return objGLWBTSYSchemeDetails;
        ...
        public async Task<GLWBTSYSchemeDetails> Glwb_Tsy_getapplicationschemedetailsbyappidclaim(long ApplicationId)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("in_applicationid", ApplicationId);
                    var result = (await conn.QueryAsync<GLWBTSYSchemeDetails>(Procedures.Glwb_Tsy_getapplicationschemedetailsbyappidclaim, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
                    if (result != null && result.Count() > 0)
                    {
        ...
        public async Task<IEnumerable<SelectListItem>> BindEmployee(string lwbaccountno)
        {
            try
            {
                ...
                {
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("_lwbaccountno", lwbaccountno);

                    var result = (await conn.QueryAsync<SelectListItem>(Procedures.bindglwbemployee, queryParameters, commandType: CommandType.StoredProcedure));
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<IEnumerable> GetGLWBEmployeeDetailsbyRegistrationid(int registrationid)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = (await conn.QueryAsync(Procedures.GetGLWBEmployeeDetailsbyRegistrationid, queryParameters, commandType: CommandType.StoredProcedure));                    
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<ResponseMessage> AddUpdateApplication(GLWB_TSYClaim_personalDetails personalDetailsModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_tsy_claim_insertpersonaldetails(@in_registrationid,@in_userprofileid," +
                        "@in_applicationid,@in_hospitalname,@in_hospitalemailid,@in_hospitaladdress," +
                        "@in_hospitalmobile,@in_hospitalpincode," +
                        "@in_createdby,@in_createddate,@in_isdeleted,@in_ipaddress,@in_hostname," +
                        "@in_sequenceno,@in_applicationno,@in_serviceid," +
                        "@in_schemaname,@in_tablename,@in_bankname,@in_bankbranch,@in_ifsccode,@in_bankaccountno,@in_applicationfrom," +
                        "@in_companyname,@in_addresss,@in_emailid,@in_city,@in_district," +
                        "@in_taluka,@in_pincode,@out_error,@out_msg,@out_id,@out_applicatinno)";

                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new Dapper.DynamicParameters();
                    queryParameters.Add("@in_registrationid", 1);
                    ...
                    queryParameters.Add("@in_hospitalname", personalDetailsModel.hospitalname);
                    queryParameters.Add("@in_hospitalemailid", personalDetailsModel.hospitalemailid);
                    queryParameters.Add("@in_hospitaladdress", personalDetailsModel.hospitaladdress);
                    queryParameters.Add("@in_hospitalmobile", personalDetailsModel.hospitalmobile);
                    queryParameters.Add("@in_hospitalpincode", personalDetailsModel.hospitalpincode);
                    ...
                    queryParameters.Add("@in_bankname", personalDetailsModel.BankName);
                    queryParameters.Add("@in_bankbranch", personalDetailsModel.BankBranch);
                    queryParameters.Add("@in_ifsccode", personalDetailsModel.IFSCCode);
                    queryParameters.Add("@in_bankaccountno", personalDetailsModel.BankAccountNo);
                    queryParameters.Add("@in_applicationfrom", personalDetailsModel.applicationfrom);
                    queryParameters.Add("@in_companyname", personalDetailsModel.companyname);
                    queryParameters.Add("@in_addresss", personalDetailsModel.address);
                    queryParameters.Add("@in_emailid", personalDetailsModel.emailid);
                    queryParameters.Add("@in_city", personalDetailsModel.city);
                    queryParameters.Add("@in_district", personalDetailsModel.district);
                    queryParameters.Add("@in_taluka", personalDetailsModel.taluka);
                    queryParameters.Add("@in_pincode", personalDetailsModel.pincode);
        ...
        public async Task<ResponseMessage> AddSchemeDetails(GLWBTSYSchemeDetails schemeDetails, DataTable dt)
        {
            ...
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_tsy_claim_insertschemedetails(@in_companytbl,@in_applicationid,@in_claimapplicationid,@in_serviceid,@in_userid,@in_sequenceno," +
                        "@in_createdby," +
                        "@in_isdeleted,@in_ipaddress,@in_hostname," +
                        "@in_schemaname,@in_tablename,@in_totalsahay,@in_finaltotalsahay,@in_remarks,@out_error,@out_msg,@out_id,@out_applicatinno)";
                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("@in_companytbl", new JsonParameter(JsonConvert.SerializeObject(dt)));
                    queryParameters.Add("@in_applicationid", schemeDetails.ApplicationId);
                    queryParameters.Add("@in_claimapplicationid", schemeDetails.ClaimApplicationId);
                    ...
                    queryParameters.Add("@in_finaltotalsahay", schemeDetails.finaltotalsahay);
                    queryParameters.Add("@in_remarks", schemeDetails.remarks);
                    queryParameters.Add("@out_error", 0, direction: ParameterDirection.InputOutput);
                    queryParameters.Add("@out_msg", "", direction: ParameterDirection.InputOutput);
                    queryParameters.Add("@out_id", 0, direction: ParameterDirection.InputOutput);
                    queryParameters.Add("@out_applicatinno", 0, direction: ParameterDirection.InputOutput);
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetails(IList<DocumentFileDetails> lstdocumentFileDetails)
        {
            try
            {
                var procName = "CALL public.glwb_tsy_insertdocumentdetails(@in_applicationid,@in_documentmasterid,@in_documentname,@in_documentnumber,@in_createddate,@in_CreatedBy," +
        ...
        public async Task<ResponseMessage> FinalSubmit(FinalSubmitModel finalSubmitModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_tsy_claim_addupdateappdeclaration(@in_applicationid,@in_claimapplicationid,@in_registrationid,@in_userid,@in_isagree,@in_ipaddress,@in_hostname," +
                    ...
                    queryParameters.Add("@in_claimapplicationid", finalSubmitModel.ClaimApplicationId);
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetailsNew(DataTable dtData)
        {
            ...
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_tsy_claim_insertdocumentdetails_json(@in_documenttbl,@in_isupdated,@in_schemaname,@in_tablename,@out_error,@out_msg,@out_applicationid,@out_id)";
        ...
        public async Task<SMSModel> GetSmsContentForService(long serviceId, long ApplicationId, int SMSType, string schemaname, string tablename)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<SMSModel>(Procedures.GLWB_TSY_claim_GetSmsContentForService, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
