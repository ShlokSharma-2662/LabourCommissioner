...
{
    public class GLWBTabibiSahayRepository : BaseRepository<TabModel>, IGLWBTabibiSahayRepository
    {
        public IConfiguration appConfig;
        public GLWBTabibiSahayRepository(IConfiguration config) : base(config)
        {
        ...
        public async Task<GLWB_TSY_personalDetails> GetCompanyDetailsByUserName(string UserName)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<GLWB_TSY_personalDetails>(Procedures.GetCompanyDetailsByUserName, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<GLWB_TSY_personalDetails> GetApplicationDetailsByAppId(long ApplicationId, string schemaname, string tablename)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<GLWB_TSY_personalDetails>(Procedures.GLWB_TSY_GetApplicationDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
        ...
        public async Task<GLWBTSYSchemeDetails> GetApplicationSchemeDetailsByAppId(long ApplicationId)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var queryParameters = new DynamicParameters();
                    queryParameters.Add("in_applicationid", ApplicationId);
                    var result = (await conn.QueryAsync<GLWBTSYSchemeDetails>(Procedures.glwb_tsy_GetApplicationSchemeDetailsByAppId, queryParameters, commandType: System.Data.CommandType.StoredProcedure)).ToList();
        ...
        public async Task<ResponseMessage> AddUpdateApplication(GLWB_TSY_personalDetails personalDetailsModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_tsy_insertpersonaldetails(@in_registrationid,@in_userprofileid," +
                        "@in_hrmanagername,@in_hrmanagermobile,@in_hrmanageremail," +
                        "@in_totalemployee," +
                        "@in_createdby,@in_createddate,@in_isdeleted,@in_ipaddress,@in_hostname," +
                        "@in_sequenceno,@in_applicationno,@in_serviceid," +
                        "@in_schemaname,@in_tablename,@in_companyname,@in_addresss,@in_emailid,@in_city,@in_district," +
                        "@in_taluka,@in_pincode,@in_lwbaccountno,@out_error,@out_msg,@out_id,@out_applicatinno)";
                    ...
                    queryParameters.Add("@in_hrmanagername", personalDetailsModel.hrManagerName);
                    queryParameters.Add("@in_hrmanagermobile", personalDetailsModel.hrManagerMobile);
                    queryParameters.Add("@in_hrmanageremail", personalDetailsModel.hrManagerEmail);
                    queryParameters.Add("@in_totalemployee", Convert.ToInt32(personalDetailsModel.totalemployee));
                    //queryParameters.Add("@in_totalemployeesforcheckup", Convert.ToInt32(personalDetailsModel.totalemployeesforcheckup));
        ...
        public async Task<ResponseMessage> AddSchemeDetails(GLWBTSYSchemeDetails schemeDetails, DataTable dt)
        {
            ...
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_tsy_insertschemedetails(@in_companytbl,@in_applicationid,@in_serviceid,@in_userid,@in_sequenceno," +
                        "@in_createdby," +
                        "@in_isdeleted,@in_ipaddress,@in_hostname,@in_bankname,@in_bankbranch,@in_ifsccode,@in_bankaccountno," +
                        "@in_schemaname,@in_tablename,@in_totalemployeesforcheckup,@in_totalsahay,@in_finaltotalsahay,@out_error,@out_msg,@out_id,@out_applicatinno)";
                    ResponseMessage res = new ResponseMessage();
                    var queryParameters = new DynamicParameters();
                    ...
                    queryParameters.Add("@in_totalemployeesforcheckup", schemeDetails.totalemployeesforcheckup);
        ...
        public async Task<ResponseMessage> FinalSubmit(FinalSubmitModel finalSubmitModel)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_tsy_addupdateappdeclaration(@in_applicationid,@in_registrationid,@in_userid,@in_isagree,@in_ipaddress,@in_hostname," +
        ...
        public async Task<ResponseMessage> AddUpdateDocumentDetailsNew(DataTable dtData)
        {
            ...
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    var procName = "CALL public.glwb_tsy_insertdocumentdetails_json(@in_documenttbl,@in_isupdated,@in_schemaname,@in_tablename,@out_error,@out_msg,@out_applicationid,@out_id)";
        ...
        public async Task<SMSModel> GetSmsContentForService(long serviceId, long ApplicationId, int SMSType, string schemaname, string tablename)
        {
            try
            {
                ...
                using (var conn = GetConnection())
                {
                    ...
                    var result = await conn.QueryFirstOrDefaultAsync<SMSModel>(Procedures.GLWB_TSY_GetSmsContentForService, queryParameters, commandType: System.Data.CommandType.StoredProcedure);
                    return result;
                }
            }
            catch (Exception ex)
