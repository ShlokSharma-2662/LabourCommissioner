...
{
    public class BOCWTabibiSahayYojanaClaimService : IBOCWTabibiSahayYojanaClaimService
    {
        private readonly IBOCWTabibiSahayYojanaClaimRepository _bocwTabibiSahayYojanaRepository;

        public BOCWTabibiSahayYojanaClaimService(IBOCWTabibiSahayYojanaClaimRepository ibocwTabibiSahayYojanaRepository)
        {
        ...
        {
            var res = _bocwTabibiSahayYojanaRepository.GetCheckedUPApplicationDetailsByServiceId(serviceId, schemaname, tablename);
            return await res;
        }

        public async Task<BOCW_TBSYClaim_personalDetails> GetCompanyDetailsByUserName(string UserName)
        {
            var res = _bocwTabibiSahayYojanaRepository.GetCompanyDetailsByUserName(UserName);
            return await res;
        }
        ...
        {
            return await _bocwTabibiSahayYojanaRepository.AddSchemeDetails(dtData);
        }
