...
{
    public class GLWBHomeTownYojanaService : IGLWBHomeTownYojanaService
    {
        private readonly IGLWBHomeTownYojanaRepository _iGLWBHomeTownYojanarepository;

        public GLWBHomeTownYojanaService(IGLWBHomeTownYojanaRepository iGLWBHomeTownYojanarepository)
        {
