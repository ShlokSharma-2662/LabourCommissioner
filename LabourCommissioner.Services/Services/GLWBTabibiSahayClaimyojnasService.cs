...
{
    public class GLWBTabibiSahayClaimyojnasService : IGLWBTabibiSahayClaimyojnasService
    {
        private readonly IGLWBTabibiSahayClaimyojnasRepository _GLWBTabibiSahayRepository;

        public GLWBTabibiSahayClaimyojnasService(IGLWBTabibiSahayClaimyojnasRepository iGLWBTabibiSahayRepository)
        {
        ...
        {
            var res = _GLWBTabibiSahayRepository.Glwb_Tsy_getapplicationschemedetailsbyappidclaim(ApplicationId);
            return await res;
        }
