...
namespace LabourCommissioner.Services.Services
{
    public class HospitalService : IHospitalService
    {
        ...
        public HospitalService(IHospitalRepository homeRepository)
        {
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> BOCW_SSY_GetApplicationDetailsList(int? pageNo, int pageSize, long districtId, long talukaId, long villageId, DateTime? fromDate, DateTime? toDate, int statusId, string? search,
            long postId, long serviceid, string? action, string? schemaName, long subServiceId)
        {
            ...
            statusId, search, postId, serviceid, action,schemaName, subServiceId);
        }
        ...
        public async Task<IEnumerable<EmpApplicationDetailsModel>> GLWB_Hospital_GetApplicationDetailsList(int? pageNo, int pageSize, long divisionId, long talukaId, long districtId, DateTime? fromDate, DateTime? toDate, int statusId, string? search,
           long postId, long serviceid, string? action, string? schemaName)
        {
            return await _homeRepository.GLWB_Hospital_GetApplicationDetailsList(pageNo, pageSize, divisionId, talukaId, districtId, fromDate, toDate,
            statusId, search, postId, serviceid, action, schemaName);
        }
