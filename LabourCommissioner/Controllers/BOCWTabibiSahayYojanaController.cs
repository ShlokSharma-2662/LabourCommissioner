...
namespace LabourCommissioner.Controllers
{
    ...
    public class BOCWTabibiSahayYojanaController : Controller
    {
        ...
        private readonly IBOCWTabibiSahayYojanaService _iBOCWTabibiSahayYojanaService;


        public BOCWTabibiSahayYojanaController(IBOCWTabibiSahayYojanaService iBOCWTabibiSahayYojanaService,
        ...
        public IActionResult AppPersonalDetails(string strid, string strTabId, string strApplicationId)
        {
            ...
            var model = _iBOCWTabibiSahayYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_tbsy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> PersonalDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            var model = await _iBOCWTabibiSahayYojanaService.GetPersonalDetailsByRegNo(RegistrationNo);
            var model1 = await _iBOCWTabibiSahayYojanaService.GetApplicationDetailsByAppId(ApplicationId, nameof(EnumLookup.schemaname.bocw_tbsy), nameof(EnumLookup.tablename.personaldetails));
            ...
            var stateModel = _iBOCWTabibiSahayYojanaService.GetAllStates();
            var states = stateModel.Result.ToList();

            ViewBag.States = states;
            ViewBag.isFilled = isFilled;

            var districtModel = _iBOCWTabibiSahayYojanaService.GetDistrict();
            ...
            if (isFilled)
            {
                ...
                var PtalukaModel = _iBOCWTabibiSahayYojanaService.GetTalukaByDistrictId(model1.PDistrictId);
                var Ptaluka = PtalukaModel.Result.ToList();

                var PvillageModel =
                    _iBOCWTabibiSahayYojanaService.GetVillageByDistrictIdAndTalukaId(model1.PDistrictId, model1.PTalukaId);
                var Pvillage = PvillageModel.Result.ToList();

                var talukaModel = _iBOCWTabibiSahayYojanaService.GetTalukaByDistrictId(model1.CDistrictId);
                var Ctaluka = talukaModel.Result.ToList();

                var villageModel =
                    _iBOCWTabibiSahayYojanaService.GetVillageByDistrictIdAndTalukaId(model1.CDistrictId, model1.CTalukaId);
                ...
                return PartialView("BOCWTabibiSahayYojana/_BOCWTabibiSahayYojanaPersonalDetails", model1);
            }

            return PartialView("BOCWTabibiSahayYojana/_BOCWTabibiSahayYojanaPersonalDetails", model);
        ...
        [HttpGet]
        public async Task<IActionResult> BOCWTabibiSahayYojanaSchemeDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            long ApplicationId = Convert.ToInt64(strApplicationId);
            ...
            //var totalsahay = _iBOCWTabibiSahayYojanaService.GetTotalsahayByServiceID(serviceId);
            ...
            ViewBag.ApplicationId = ApplicationId;
            return PartialView("BOCWTabibiSahayYojana/_BOCWTabibiSahayYojanaSchemeDetails", model1);
        }

        [HttpGet]
        public async Task<IActionResult> BOCWTabibiSahayYojanaDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            if (isFilled == true)
            {
                var GetUploadedDocuments = await _iBOCWTabibiSahayYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.bocw_tbsy), nameof(EnumLookup.tablename.documentdetails));
                return PartialView("BOCWTabibiSahayYojana/_BOCWTabibiSahayYojanaDocument", GetUploadedDocuments);
            }
            else
            {
                return PartialView("BOCWTabibiSahayYojana/_BOCWTabibiSahayYojanaDocument", model);
            }



            //IEnumerable<DocumentDetails> model = await _iBOCWTabibiSahayYojanaService.GetFileDocuments(Convert.ToInt32(ServiceId));
            //return PartialView("BOCWSikshanSahayYojana/_BOCWSikshanSahayYojanaDocument", model);

            //DocumentDetails model = await _iBOCWTabibiSahayYojanaService.GetDocumentsDetails(Convert.ToInt32(ServiceId));
            // return PartialView("BOCWSikshanSahayYojana/_BOCWSikshanSahayYojanaDocument", model);
        }
        ...
        public IActionResult TermsCondition(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            return PartialView("BOCWTabibiSahayYojana/_BOCWTabibiSahayYojanaTermsCondition");
        }
        ...
        public async Task<IActionResult> AddUpdateApplication(PersonalDetailsModel personalDetails, string strTabId, string strApplicationNo)
        {
            ...
            personalDetails.schemaname = nameof(EnumLookup.schemaname.bocw_tbsy);
            ...
            if (personalDetails.Photo != null && personalDetails.FileName != "" && personalDetails.Photo.Length > 0)
            {
                ...
                else
                {
                    ...
                    return RedirectToAction("AppPersonalDetails", "BOCWTabibiSahayYojana", personalDetails);
                }
            }
            ...
            if (regResponse != null)
            {
                ...
                else
                {
                    ...
                    return RedirectToAction("AppPersonalDetails", "BOCWTabibiSahayYojana");
                }
            }
            ...
            return RedirectToAction("BOCWTabibiSahayYojanaSchemeDetails", "BOCWTabibiSahayYojana");
        }

        public async Task<IActionResult> AddSchemeDetails(BOCWTBSYSchemeDetails schemeDetails, int TabSequenceNo, int ApplicationId)
        {
            ...
            schemeDetails.schemaname = nameof(EnumLookup.schemaname.bocw_tbsy);
            ...
            var regResponse = await _iBOCWTabibiSahayYojanaService.AddSchemeDetails(schemeDetails);
            return RedirectToAction("AppPersonalDetails",
        ...
        public async Task<IActionResult> UploadDocument(IList<DocumentFileDetails> documentFileDetails, string strTabSequenceNo, string strApplicationId, string strServiceId)
        {
            ...
            if (documentFileDetails != null && documentFileDetails.Count() > 0)
            {
                ...
                foreach (var item in documentFileDetails)
                {
                        ...
                        item.IdImage.File.Length > 0)
                    {
                        ...
                        if (couchDBResponse != null && couchDBResponse.IsSuccess)
                        {
                            ...
                            objdocumentFileDetails.schemaname = nameof(EnumLookup.schemaname.bocw_tbsy);
                        ...
                        {
                            return PartialView("BOCWTabibiSahayYojana/_BOCWTabibiSahayYojanaDocument");
                        }
                    }
                }
                ...
                //ResponseMessage model = await _iBOCWTabibiSahayYojanaService.AddUpdateDocumentDetails(lstdocumentFileDetails);
                return RedirectToAction("AppPersonalDetails",
            ...
            //else
            //{
            //    IList<DocumentFileDetails> model = await _iBOCWTabibiSahayYojanaService.GetDocumentFileDetails(Convert.ToInt32(2));
            //    return RedirectToAction("AppPersonalDetails", new { id = 2, TabId = 4 });
            //}
            ...
            //    //{
            //    //    List<DocumentDetails> model = await _iBOCWTabibiSahayYojanaService.SaveDocumentDetails(lstcouchDBResponse);
            //    //    return PartialView("BOCWSikshanSahayYojana/_BOCWSikshanSahayYojanaDocument", model);
            //    //}
            ...
            //return View();
            return RedirectToAction("AppPersonalDetails", "BOCWTabibiSahayYojana", documentFileDetails);
        }
        ...
        public async Task<IActionResult> FinalSubmit(FinalSubmitModel finalSubmitModel, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            finalSubmitModel.schemaname = nameof(EnumLookup.schemaname.bocw_tbsy);
            ...
            if (regResponse != null)
                if (regResponse != null && regResponse.Error == 0)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWTabibiSahayYojanaService.GetSmsContentForService(serviceId, ApplicationId, (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_tbsy), nameof(EnumLookup.tablename.personaldetails));
            ...
            return RedirectToAction("TermsCondition", "BOCWTabibiSahayYojana");
        }
