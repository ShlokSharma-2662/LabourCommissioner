...
{
    public class BOCWTabletSahayYojanaController : Controller
    {
        // BOCWTabletSahayYojana
        ...
        private readonly IBOCWTabletSahayYojanaService _iBOCWTabletSahayYojanaService;


        public BOCWTabletSahayYojanaController(IBOCWTabletSahayYojanaService iBOCWTabletSahayYojanaService,
         IConfiguration config, IHttpClientFactory clientFactory,
         IHttpContextAccessor httpContextAccessor, IWebHostEnvironment webHostEnvironment)
        {
            _iBOCWTabletSahayYojanaService = iBOCWTabletSahayYojanaService ??
                                              throw new ArgumentNullException(nameof(_iBOCWTabletSahayYojanaService));
        ...
        public IActionResult AppPersonalDetails(string strid, string strTabId, string strApplicationId)
        {
            ...
            var model = _iBOCWTabletSahayYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_tsy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> PersonalDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            var model = await _iBOCWTabletSahayYojanaService.GetPersonalDetailsByRegNo(RegistrationNo);
            var model1 = await _iBOCWTabletSahayYojanaService.GetApplicationDetailsByAppId(ApplicationId, nameof(EnumLookup.schemaname.bocw_tsy), nameof(EnumLookup.tablename.personaldetails));
            ...
            var stateModel = _iBOCWTabletSahayYojanaService.GetAllStates();
            var states = stateModel.Result.ToList();

            ViewBag.States = states;
            ViewBag.isFilled = isFilled;

            var districtModel = _iBOCWTabletSahayYojanaService.GetDistrict();
            ...
            if (isFilled)
            {
                ...
                var PtalukaModel = _iBOCWTabletSahayYojanaService.GetTalukaByDistrictId(model1.PDistrictId);
                var Ptaluka = PtalukaModel.Result.ToList();

                var PvillageModel =
                    _iBOCWTabletSahayYojanaService.GetVillageByDistrictIdAndTalukaId(model1.PDistrictId, model1.PTalukaId);
                var Pvillage = PvillageModel.Result.ToList();

                var talukaModel = _iBOCWTabletSahayYojanaService.GetTalukaByDistrictId(model1.CDistrictId);
                var Ctaluka = talukaModel.Result.ToList();

                var villageModel =
                    _iBOCWTabletSahayYojanaService.GetVillageByDistrictIdAndTalukaId(model1.CDistrictId, model1.CTalukaId);
                ...
                return PartialView("BOCWTabletSahayYojana/_BOCWTabletYojanaPersonalDetails", model1);
            }

            return PartialView("BOCWTabletSahayYojana/_BOCWTabletYojanaPersonalDetails", model);
        ...
        [HttpGet]
        public async Task<IActionResult> BOCWTabletSahayYojanaSchemedetails(string ServiceId, string strApplicationId, bool isFilled)
        {



            long ApplicationId = Convert.ToInt64(strApplicationId);
            var model1 = await _iBOCWTabletSahayYojanaService.GetApplicationSchemeDetailsByAppId(ApplicationId);
            ViewBag.isFilled = isFilled;
            ...
            ViewBag.ApplicationId = ApplicationId;
            return PartialView("BOCWTabletSahayYojana/_BOCWTabletYojanaSchemeDetails", model1);
            ...
            //    var educationModel = _iBOCWTabletSahayYojanaService.GetEducation(nameof(EnumLookup.ResourcesType.Education));
            //    var education = educationModel.Result.ToList();
            //    ViewBag.Syllabus = education;

            //    var semesterModel = _iBOCWTabletSahayYojanaService.GetEducation(nameof(EnumLookup.ResourcesType.Semester));
            ...
            //    if (model1 == null)
            //    {
            //        var degreeModel = _iBOCWTabletSahayYojanaService.GetEducation(nameof(EnumLookup.ResourcesType.Degree));
            ...
            //        if (isFilled == true)
            //        {
            //            var semesterYear = _iBOCWTabletSahayYojanaService.GetSemesterbyCourseId(Convert.ToInt32(model1.Course));
            //            semester = semesterYear.Result.ToList();
            //            var degreeModel = _iBOCWTabletSahayYojanaService.GetSubject(Convert.ToString(model1.Syllabus));
            //            var degree = degreeModel.Result.ToList();
            //            ViewBag.Degree = degree;
            //            ViewBag.Semester = semester;
            //        }
        ...
        [HttpGet]
        public async Task<IActionResult> BOCWTabletYojanaDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            string ApplicationId = strApplicationId;
            ViewBag.ServiceId = ServiceId;
            ViewBag.ApplicationId = ApplicationId;
            ViewBag.TabSequenceNo = 3;
            var model = await _iBOCWTabletSahayYojanaService.GetDocumentFileDetails(Convert.ToInt32(ServiceId), Convert.ToInt32(ApplicationId));


            if (isFilled == true)
            {
                var GetUploadedDocuments = await _iBOCWTabletSahayYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.bocw_tsy), nameof(EnumLookup.tablename.documentdetails));
                return PartialView("BOCWTabletSahayYojana/_BOCWTabletYojanaDocument", GetUploadedDocuments);
            }
            else
            {
                return PartialView("BOCWTabletSahayYojana/_BOCWTabletYojanaDocument", model);
            }



            //IEnumerable<DocumentDetails> model = await _iBOCWTabletSahayYojanaService.GetFileDocuments(Convert.ToInt32(ServiceId));
            //return PartialView("BOCWSikshanSahayYojana/_BOCWSikshanSahayYojanaDocument", model);

            //DocumentDetails model = await _iBOCWTabletSahayYojanaService.GetDocumentsDetails(Convert.ToInt32(ServiceId));
            // return PartialView("BOCWSikshanSahayYojana/_BOCWSikshanSahayYojanaDocument", model);
        }
        ...
        public IActionResult TermsCondition(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            return PartialView("BOCWTabletSahayYojana/_BOCWTabletYojanaTermsCondition");
        }
        ...
        {
            var regions = _iBOCWTabletSahayYojanaService.GetDistrict();
        ...
        {
            var subject = _iBOCWTabletSahayYojanaService.GetSubject(subjectId);
        ...
        {
            var course = _iBOCWTabletSahayYojanaService.GetBenifitByCourseId(courseId, semesteryear);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        ...
        {
            var regions = _iBOCWTabletSahayYojanaService.GetTalukaByDistrictId(districtId);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        public IActionResult GetSemesterbyCourseId(int courseid)
        {
            var regions = _iBOCWTabletSahayYojanaService.GetSemesterbyCourseId(courseid);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        ...
        {
            var regions = _iBOCWTabletSahayYojanaService.GetVillageByDistrictIdAndTalukaId(districtId, talukaId);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        ...
        {
            var regions = _iBOCWTabletSahayYojanaService.GetEducation(nameof(EnumLookup.ResourcesType.Education));
            return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        }
        ...
        public async Task<IActionResult> AddUpdateApplication(PersonalDetailsModel personalDetails, string strTabId, string strApplicationNo)
        {
            ...
            personalDetails.schemaname = nameof(EnumLookup.schemaname.bocw_tsy);
            ...
            if (personalDetails.Photo != null && personalDetails.FileName != "" && personalDetails.Photo.Length > 0)
            {
                ...
                else
                {
                    ...
                    return RedirectToAction("AppPersonalDetails", "BOCWTabletSahayYojana", personalDetails);
                }
            }
            ...
            var regResponse = await _iBOCWTabletSahayYojanaService.AddUpdateApplication(personalDetails);
            if (regResponse != null)
            {
                ...
                else
                {
                    ...
                    return RedirectToAction("AppPersonalDetails", "BOCWTabletSahayYojana");
                }
            }
            ...
            return RedirectToAction("BOCWTabletSahayYojanaSchemedetails", "BOCWTabletSahayYojana");
        }

        public async Task<IActionResult> AddSchemeDetails(BOCWTSYSchemeDetails schemeDetails, int TabSequenceNo, int ApplicationId)
        {
            ...
            schemeDetails.schemaname = nameof(EnumLookup.schemaname.bocw_tsy);
            ...
            var regResponse = await _iBOCWTabletSahayYojanaService.AddSchemeDetails(schemeDetails);
            return RedirectToAction("AppPersonalDetails",
        ...
        public async Task<IActionResult> UploadDocument(IList<DocumentFileDetails> documentFileDetails, string strTabSequenceNo, string strApplicationId, string strServiceId)
        {
            ...
            if (documentFileDetails != null && documentFileDetails.Count() > 0)
            {
                ...
                foreach (var item in documentFileDetails)
                {
                        ...
                        item.IdImage.File.Length > 0)
                    {
                        ...
                        if (couchDBResponse != null && couchDBResponse.IsSuccess)
                        {
                            ...
                            objdocumentFileDetails.schemaname = nameof(EnumLookup.schemaname.bocw_tsy);
                        ...
                        {
                            return PartialView("BOCWTabletSahayYojana/_BOCWTabletYojanaDocument");
                        }
                    }
                }
                ...
                {
                    responseMessage = await _iBOCWTabletSahayYojanaService.AddUpdateDocumentDetailsNew(dtData);
                }
                ...
                //ResponseMessage model = await _iBOCWTabletSahayYojanaService.AddUpdateDocumentDetails(lstdocumentFileDetails);
                return RedirectToAction("AppPersonalDetails",
            ...
            //else
            //{
            //    IList<DocumentFileDetails> model = await _iBOCWTabletSahayYojanaService.GetDocumentFileDetails(Convert.ToInt32(2));
            //    return RedirectToAction("AppPersonalDetails", new { id = 2, TabId = 4 });
            //}
            ...
            //    //{
            //    //    List<DocumentDetails> model = await _iBOCWTabletSahayYojanaService.SaveDocumentDetails(lstcouchDBResponse);
            //    //    return PartialView("BOCWSikshanSahayYojana/_BOCWSikshanSahayYojanaDocument", model);
            //    //}
            ...
            //return View();
            return RedirectToAction("AppPersonalDetails", "BOCWTabletSahayYojana", documentFileDetails);
        }
        ...
        public async Task<IActionResult> FinalSubmit(FinalSubmitModel finalSubmitModel, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            finalSubmitModel.schemaname = nameof(EnumLookup.schemaname.bocw_tsy);
            ...
            var regResponse = await _iBOCWTabletSahayYojanaService.FinalSubmit(finalSubmitModel);
            if (regResponse != null)
                if (regResponse != null && regResponse.Error == 0)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWTabletSahayYojanaService.GetSmsContentForService(serviceId, ApplicationId, (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_tsy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWTabletSahayYojanaService.AddSMSLogs(modelSMSModel.MobileNo, serviceId, modelSMSModel.SmsContent, Convert.ToInt32(_claimPincipal.FindFirstValue("RegistrationId")));
                        }
            ...
            return RedirectToAction("TermsCondition", "BOCWTabletSahayYojana");
        }
