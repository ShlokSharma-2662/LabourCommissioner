...
namespace LabourCommissioner.Controllers
{
    ...
    [Authorize]
    public class BOCWVishishtaCoachingYojanaController : Controller
    {
        ...
        private readonly IBOCWVishishtaCoachingYojanaService _iBOCWVishishtaCoachingYojanaService;

        public BOCWVishishtaCoachingYojanaController(IBOCWVishishtaCoachingYojanaService ibocwNanajiYojanaRepository,
            IConfiguration config, IHttpClientFactory clientFactory,
            IHttpContextAccessor httpContextAccessor, IWebHostEnvironment webHostEnvironment)
        {
            _iBOCWVishishtaCoachingYojanaService = ibocwNanajiYojanaRepository ??
                                              throw new ArgumentNullException(nameof(_iBOCWVishishtaCoachingYojanaService));
        ...
        public IActionResult AppPersonalDetails(string strid, string strTabId, string strApplicationId)
        {
            ...
            var model = _iBOCWVishishtaCoachingYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_vcy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> PersonalDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            var model = await _iBOCWVishishtaCoachingYojanaService.GetPersonalDetailsByRegNo(RegistrationNo);
            var model1 = await _iBOCWVishishtaCoachingYojanaService.GetApplicationDetailsByAppId(ApplicationId, nameof(EnumLookup.schemaname.bocw_vcy), nameof(EnumLookup.tablename.personaldetails));
            ...
            var stateModel = _iBOCWVishishtaCoachingYojanaService.GetAllStates();
            var states = stateModel.Result.ToList();

            ViewBag.States = states;
            ViewBag.isFilled = isFilled;

            var districtModel = _iBOCWVishishtaCoachingYojanaService.GetDistrict();
            ...
            if (isFilled)
            {
                ...
                var PtalukaModel = _iBOCWVishishtaCoachingYojanaService.GetTalukaByDistrictId(model1.PDistrictId);
                var Ptaluka = PtalukaModel.Result.ToList();

                var PvillageModel =
                    _iBOCWVishishtaCoachingYojanaService.GetVillageByDistrictIdAndTalukaId(model1.PDistrictId, model1.PTalukaId);
                var Pvillage = PvillageModel.Result.ToList();

                var talukaModel = _iBOCWVishishtaCoachingYojanaService.GetTalukaByDistrictId(model1.CDistrictId);
                var Ctaluka = talukaModel.Result.ToList();

                var villageModel =
                    _iBOCWVishishtaCoachingYojanaService.GetVillageByDistrictIdAndTalukaId(model1.CDistrictId, model1.CTalukaId);
                ...
                return PartialView("BOCWVishishtaCoachingYojana/_BOCWVishishtaCoachingYojanaPersonalDetails", model1);
            }

            return PartialView("BOCWVishishtaCoachingYojana/_BOCWVishishtaCoachingYojanaPersonalDetails", model);


            //return PartialView("BOCWVishishtaCoachingYojana/_PersonalDetails", model);
        }

        [HttpGet]
        public async Task<IActionResult> BOCWVishishtaCoachingYojanaSchemeDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            long ApplicationId = Convert.ToInt64(strApplicationId);
            //int serviceId = Convert.ToInt32(ServiceId);
            var model1 = await _iBOCWVishishtaCoachingYojanaService.GetApplicationSchemeDetailsByAppId(ApplicationId);
            ViewBag.isFilled = isFilled;

            //var totalsahay = _iBOCWVishishtaCoachingYojanaService.GetTotalsahayByServiceID(serviceId);
            ...
            return PartialView("BOCWVishishtaCoachingYojana/_BOCWVishishtaCoachingYojanaSchemeDetails", model1);
        }

        [HttpGet]
        public async Task<IActionResult> BOCWVishishtaCoachingYojanaDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            string ApplicationId = strApplicationId;
            ViewBag.ServiceId = ServiceId;
            ViewBag.ApplicationId = ApplicationId;
            ViewBag.TabSequenceNo = 3;
            var model = await _iBOCWVishishtaCoachingYojanaService.GetDocumentFileDetails(Convert.ToInt32(ServiceId), Convert.ToInt32(ApplicationId));


            if (isFilled == true)
            {
                var GetUploadedDocuments = await _iBOCWVishishtaCoachingYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.bocw_vcy), nameof(EnumLookup.tablename.documentdetails));
                return PartialView("BOCWVishishtaCoachingYojana/_BOCWVishishtaCoachingYojanaDocument", GetUploadedDocuments);
            }
            else
            {
                return PartialView("BOCWVishishtaCoachingYojana/_BOCWVishishtaCoachingYojanaDocument", model);
            }           
        }
        ...
        public IActionResult TermsCondition(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            return PartialView("BOCWVishishtaCoachingYojana/_BOCWVishishtaCoachingYojanaTermsCondition");
        }
        ...
        {
            var regions = _iBOCWVishishtaCoachingYojanaService.GetDistrict();
        ...
        {
            var subject = _iBOCWVishishtaCoachingYojanaService.GetSubject(subjectId);
        ...
        {
            var course = _iBOCWVishishtaCoachingYojanaService.GetBenifitByCourseId(courseId, semesteryear);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        ...
        {
            var regions = _iBOCWVishishtaCoachingYojanaService.GetTalukaByDistrictId(districtId);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        public IActionResult GetSemesterbyCourseId(int courseid)
        {
            var regions = _iBOCWVishishtaCoachingYojanaService.GetSemesterbyCourseId(courseid);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        ...
        {
            var regions = _iBOCWVishishtaCoachingYojanaService.GetVillageByDistrictIdAndTalukaId(districtId, talukaId);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        ...
        {
            var regions = _iBOCWVishishtaCoachingYojanaService.GetEducation(nameof(EnumLookup.ResourcesType.Education));
            return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        }
        ...
        public async Task<IActionResult> AddUpdateApplication(PersonalDetailsModel personalDetails, string strTabId, string strApplicationNo)
        {
            ...
            personalDetails.schemaname = nameof(EnumLookup.schemaname.bocw_vcy);
            ...
            if (personalDetails.Photo != null && personalDetails.FileName != "" && personalDetails.Photo.Length > 0)
            {
                ...
                else
                {
                    ...
                    return RedirectToAction("AppPersonalDetails", "BOCWVishishtaCoachingYojana", personalDetails);
                }
            }
            ...
            var regResponse = await _iBOCWVishishtaCoachingYojanaService.AddUpdateApplication(personalDetails);
            if (regResponse != null)
            {
                ...
                if (regResponse != null && regResponse != null && regResponse.Error == 0)
                {
                    ...
                    //return RedirectToAction("BOCWSikshanSahayYojanaSchemeDetails", "BOCWVishishtaCoachingYojana");
                ...
                else
                {
                    ...
                    return RedirectToAction("AppPersonalDetails", "BOCWVishishtaCoachingYojana");
                }
            }
            ...
            return RedirectToAction("BOCWNanajiYojanaSchemeDetails", "BOCWVishishtaCoachingYojana");
        }

        public async Task<IActionResult> AddSchemeDetails(BOCWVCYSchemeDetails schemeDetails, int TabSequenceNo, int ApplicationId)
        {
            ...
            schemeDetails.schemaname = nameof(EnumLookup.schemaname.bocw_vcy);
            ...
            var regResponse = await _iBOCWVishishtaCoachingYojanaService.AddSchemeDetails(schemeDetails);
            return RedirectToAction("AppPersonalDetails",
        ...
        public async Task<IActionResult> UploadDocument(IList<DocumentFileDetails> documentFileDetails, string strTabSequenceNo, string strApplicationId, string strServiceId)
        {
            ...
            if (documentFileDetails != null && documentFileDetails.Count() > 0)
            {
                ...
                foreach (var item in documentFileDetails)
                {
                        ...
                        item.IdImage.File.Length > 0)
                    {
                        ...
                        if (couchDBResponse != null && couchDBResponse.IsSuccess)
                        {
                            ...
                            objdocumentFileDetails.schemaname = nameof(EnumLookup.schemaname.bocw_vcy);
                        ...
                        {
                            return PartialView("BOCWVishishtaCoachingYojana/_BOCWVishishtaCoachingYojanaDocument");
                        }
                    }
                }
                ...
                {
                    responseMessage = await _iBOCWVishishtaCoachingYojanaService.AddUpdateDocumentDetailsNew(dtData);
                }
                ...
                //ResponseMessage model = await _iBOCWVishishtaCoachingYojanaService.AddUpdateDocumentDetails(lstdocumentFileDetails);
                return RedirectToAction("AppPersonalDetails",
            ...
            //else
            //{
            //    IList<DocumentFileDetails> model = await _iBOCWVishishtaCoachingYojanaService.GetDocumentFileDetails(Convert.ToInt32(2));
            //    return RedirectToAction("AppPersonalDetails", new { id = 2, TabId = 4 });
            //}
            ...
            //            else
            //            {
            //                return PartialView("BOCWVishishtaCoachingYojana/_BOCWSikshanSahayYojanaDocument");
            //            }
            //        }
            //        else
            //        {
            ...
            //    //{
            //    //    List<DocumentDetails> model = await _iBOCWVishishtaCoachingYojanaService.SaveDocumentDetails(lstcouchDBResponse);
            //    //    return PartialView("BOCWVishishtaCoachingYojana/_BOCWSikshanSahayYojanaDocument", model);
            //    //}
            ...
            //return View();
            return RedirectToAction("AppPersonalDetails", "BOCWVishishtaCoachingYojana", documentFileDetails);
        }
        ...
        public async Task<IActionResult> FinalSubmit(FinalSubmitModel finalSubmitModel, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            //finalSubmitModel.tablename = "bocw_vcy.personaldetails";
            //finalSubmitModel.schemaname = "bocw_vcy";
            finalSubmitModel.tablename = nameof(EnumLookup.tablename.personaldetails);
            finalSubmitModel.schemaname = nameof(EnumLookup.schemaname.bocw_vcy);
            ...
            var regResponse = await _iBOCWVishishtaCoachingYojanaService.FinalSubmit(finalSubmitModel);
            if (regResponse != null)
                if (regResponse != null && regResponse.Error == 0)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWVishishtaCoachingYojanaService.GetSmsContentForService(serviceId, ApplicationId, (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_vcy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWVishishtaCoachingYojanaService.AddSMSLogs(modelSMSModel.MobileNo, serviceId, modelSMSModel.SmsContent, Convert.ToInt32(_claimPincipal.FindFirstValue("RegistrationId")));
                        }
            ...
            return RedirectToAction("TermsCondition", "BOCWVishishtaCoachingYojana");
        }
