...
namespace LabourCommissioner.Controllers
{
    public class GLWBCycleYojnaController : Controller
    {
        ...
        private readonly IGLWBCycleYojnaService _iGLWBCycleYojnaservice;

        public GLWBCycleYojnaController(IGLWBCycleYojnaService iGLWBCycleYojnaservice, IConfiguration config, IHttpClientFactory clientFactory, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment webHostEnvironment)
        {
            _iGLWBCycleYojnaservice = iGLWBCycleYojnaservice ??
                                              throw new ArgumentNullException(nameof(_iGLWBCycleYojnaservice));
        ...
        public IActionResult AppPersonalDetails(string strid, string strTabId, string strApplicationId)
        {
            ...
            var model = _iGLWBCycleYojnaservice.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_csy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> PersonalDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            var model = await _iGLWBCycleYojnaservice.GetPersonalDetailsByRegNo(RegistrationNo);
            var model1 = await _iGLWBCycleYojnaservice.GetApplicationDetailsByAppId(ApplicationId, nameof(EnumLookup.schemaname.glwb_csy), nameof(EnumLookup.tablename.personaldetails));
            ...
            var stateModel = _iGLWBCycleYojnaservice.GetAllStates();
            var states = stateModel.Result.ToList();

            ViewBag.States = states;
            ViewBag.isFilled = isFilled;

            var districtModel = _iGLWBCycleYojnaservice.GetDistrict();
            ...
            if (isFilled)
            {
                ...
                //var PtalukaModel = _iGLWBCycleYojnaservice.GetTalukaByDistrictId(model1.PDistrictId);
                //var Ptaluka = PtalukaModel.Result.ToList();

                //var PvillageModel =
                //    _iGLWBCycleYojnaservice.GetVillageByDistrictIdAndTalukaId(model1.PDistrictId, model1.PTalukaId);
                //var Pvillage = PvillageModel.Result.ToList();

                var talukaModel = _iGLWBCycleYojnaservice.GetTalukaByDistrictId(model1.CDistrictId);
                var Ctaluka = talukaModel.Result.ToList();

                var villageModel =
                    _iGLWBCycleYojnaservice.GetVillageByDistrictIdAndTalukaId(model1.CDistrictId, model1.CTalukaId);
                var Cvillage = villageModel.Result.ToList();
                model1.RegistrationNo = RegistrationNo;
                ...
                return PartialView("GLWBCycleYojna/_GLWBCycleYojnaPersonalDetails", model1);
            }

            return PartialView("GLWBCycleYojna/_GLWBCycleYojnaPersonalDetails", model);
        ...
        [HttpGet]
        public async Task<IActionResult> GLWBCycleYojnaSchemeDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            long ApplicationId = Convert.ToInt64(strApplicationId);
            ...
            var model1 = await _iGLWBCycleYojnaservice.GetApplicationSchemeDetailsByAppId(ApplicationId);
            ViewBag.isFilled = isFilled;

            var totalsahay = _iGLWBCycleYojnaservice.GetTotalsahayByServiceID(serviceId);
            ...
            ViewBag.ApplicationId = ApplicationId;
            return PartialView("GLWBCycleYojna/_GLWBCycleYojnaSchemeDetails", model1);
        }

        [HttpGet]
        public async Task<IActionResult> GLWBCycleYojnaDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            var model = await _iGLWBCycleYojnaservice.GetDocumentFileDetails(Convert.ToInt32(ServiceId), Convert.ToInt32(ApplicationId));


            if (isFilled == true)
            {
                var GetUploadedDocuments = await _iGLWBCycleYojnaservice.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.glwb_csy), nameof(EnumLookup.tablename.documentdetails));
                return PartialView("GLWBCycleYojna/_GLWBCycleYojnaDocument", GetUploadedDocuments);
            }
            else
            {
                return PartialView("GLWBCycleYojna/_GLWBCycleYojnaDocument", model);
            }
        }
        ...
        public IActionResult TermsCondition(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            return PartialView("GLWBCycleYojna/_GLWBCycleYojnaTermsCondition");
        }
        ...
        {
            var regions = _iGLWBCycleYojnaservice.GetDistrict();
        ...
        {
            var regions = _iGLWBCycleYojnaservice.GetTalukaByDistrictId(districtId);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        ...
        {
            var regions = _iGLWBCycleYojnaservice.GetVillageByDistrictIdAndTalukaId(districtId, talukaId);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        ...
        {
            var regions = _iGLWBCycleYojnaservice.GetEducation(nameof(EnumLookup.ResourcesType.Education));
            return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        //[PermissionRequirement(PermissionConstant.IsInsert, PermissionConstant.IsUpdate)]
        public async Task<IActionResult> AddUpdateApplication(GLWBCycle_personalDetails personalDetails, string strTabId, string strApplicationNo)
        {
            ...
            personalDetails.schemaname = nameof(EnumLookup.schemaname.glwb_csy);
            ...
            if (personalDetails.Photo != null && personalDetails.FileName != "" && personalDetails.Photo.Length > 0)
            {
                ...
                else
                {
                    ...
                    return RedirectToAction("AppPersonalDetails", "GLWBCycleYojna", personalDetails);
                }
            }
            ...
            var regResponse = await _iGLWBCycleYojnaservice.AddUpdateApplication(personalDetails);
            if (regResponse != null)
            {
                ...
                else
                {
                    ...
                    return RedirectToAction("AppPersonalDetails", "GLWBCycleYojna");
                }
            }
            ...
            return RedirectToAction("GLWBCycleYojnaSchemeDetails", "GLWBCycleYojna");
        }

        public async Task<IActionResult> AddSchemeDetails(GLWBCYCLE_Schemedetails schemeDetails, int TabSequenceNo, int ApplicationId)
        {
            ...
            schemeDetails.schemaname = nameof(EnumLookup.schemaname.glwb_csy);
            ...
            var regResponse = await _iGLWBCycleYojnaservice.AddSchemeDetails(schemeDetails);
            return RedirectToAction("AppPersonalDetails",
        ...
        public async Task<IActionResult> UploadDocument(IList<DocumentFileDetails> documentFileDetails, string strTabSequenceNo, string strApplicationId, string strServiceId)
        {
            ...
            if (documentFileDetails != null && documentFileDetails.Count() > 0)
            {
                ...
                foreach (var item in documentFileDetails)
                {
                        ...
                        item.IdImage.File.Length > 0)
                    {
                        ...
                        {
                            return PartialView("GLWBCycleYojna/_GLWBCycleYojnaDocument");
                        }
                    }
                }
                ...
                {
                    responseMessage = await _iGLWBCycleYojnaservice.AddUpdateDocumentDetailsNew(dtData);
                }
            ...
            //return View();
            return RedirectToAction("AppPersonalDetails", "GLWBCycleYojna", documentFileDetails);
        }
        ...
        public async Task<IActionResult> FinalSubmit(FinalSubmitModel finalSubmitModel, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            finalSubmitModel.schemaname = nameof(EnumLookup.schemaname.glwb_csy);
            ...
            var regResponse = await _iGLWBCycleYojnaservice.FinalSubmit(finalSubmitModel);
            if (regResponse != null)
                if (regResponse != null && regResponse.Error == 0)
                {
                    ...
                    SMSModel modelSMSModel = await _iGLWBCycleYojnaservice.GetSmsContentForService(serviceId, ApplicationId, (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.glwb_csy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iGLWBCycleYojnaservice.AddSMSLogs(modelSMSModel.MobileNo, serviceId, modelSMSModel.SmsContent, Convert.ToInt32(_claimPincipal.FindFirstValue("RegistrationId")));
                        }
            ...
            return RedirectToAction("TermsCondition", "GLWBCycleYojna");
        }
