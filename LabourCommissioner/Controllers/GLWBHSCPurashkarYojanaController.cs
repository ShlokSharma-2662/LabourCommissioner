...
namespace LabourCommissioner.Controllers
{
    ...
    public class GLWBHSCPurashkarYojanaController : Controller
    {
        ...
        public GLWBHSCPurashkarYojanaController(IGLWBHSCPurashkarYojanaService iglwbhscpurashkaryojanaservice, IConfiguration config, IHttpClientFactory clientFactory, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult GLWBHSCPurashkarYojanaAppPersonalDetails(string strid, string strTabId, string strApplicationId)
        {
            ...
            var model = _iglwbhscpurashkaryojanaservice.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_hsc), nameof(EnumLookup.tablename.tabentry));
        ...
        [HttpGet]
        public async Task<IActionResult> GLWBHSCPurashkarYojanaPersonalDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            var RegistrationNo = User.FindFirst(ClaimTypes.Name).Value;
            ViewBag.RegNo = RegistrationNo;
            ...
            var model = await _iglwbhscpurashkaryojanaservice.GetPersonalDetailsByRegNo(RegistrationNo);
            var model1 = await _iglwbhscpurashkaryojanaservice.GetApplicationDetailsByAppId(ApplicationId, nameof(EnumLookup.schemaname.glwb_hsc), nameof(EnumLookup.tablename.personaldetails));

            model.ApplicationNo = User.FindFirst(ClaimTypes.Name).Value;
            ViewBag.ServiceId = ServiceId;
            ViewBag.TabSequenceNo = 1;

            var stateModel = _iglwbhscpurashkaryojanaservice.GetAllStates();
            var states = stateModel.Result.ToList();

            ViewBag.States = states;
            ViewBag.isFilled = isFilled;

            var districtModel = _iglwbhscpurashkaryojanaservice.GetDistrict();
            ...
            if (isFilled)
            {
                ...
                var talukaModel = _iglwbhscpurashkaryojanaservice.GetTalukaByDistrictId(model1.CDistrictId);
                var Ctaluka = talukaModel.Result.ToList();

                var villageModel =
                    _iglwbhscpurashkaryojanaservice.GetVillageByDistrictIdAndTalukaId(model1.CDistrictId, model1.CTalukaId);
                ...
                return PartialView("GLWBHSCPurashkarYojana/_GLWBHSCPurashkarYojanaPersonalDetails", model1);
            }
            model.AadharCardNo = "";
            return PartialView("GLWBHSCPurashkarYojana/_GLWBHSCPurashkarYojanaPersonalDetails", model);


            //return PartialView("GLWBHSCPurashkarYojana/_PersonalDetails", model);
        }

        [HttpGet]
        public async Task<IActionResult> GLWBHSCPurashkarYojanaSchemeDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            var RegistrationNo = User.FindFirst(ClaimTypes.Name).Value;
            var model = await _iglwbhscpurashkaryojanaservice.GetPersonalDetailsByRegNo(RegistrationNo);
            ...
            var model1 = await _iglwbhscpurashkaryojanaservice.GetApplicationSchemeDetailsByAppId(ApplicationId);
            //if (model1 == null)
            //{
            ...
            var totalsahay = _iglwbhscpurashkaryojanaservice.GetTotalsahayByServiceID(serviceId);
            ...
            return PartialView("GLWBHSCPurashkarYojana/_GLWBHSCPurashkarYojanaSchemeDetails", model1);
        }

        [HttpGet]
        public async Task<IActionResult> GLWBHSCPurashkarYojanaDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            string ApplicationId = strApplicationId;
            ViewBag.ServiceId = ServiceId;
            ViewBag.ApplicationId = ApplicationId;
            ViewBag.TabSequenceNo = 3;
            var model = await _iglwbhscpurashkaryojanaservice.GetDocumentFileDetails(Convert.ToInt32(ServiceId));

            var schemaname = nameof(EnumLookup.schemaname.glwb_hsc);
            var tablename = nameof(EnumLookup.tablename.documentdetails);
            if (isFilled == true)
            {
                var GetUploadedDocuments = await _iglwbhscpurashkaryojanaservice.GetUploadedDocuments(Convert.ToInt64(ApplicationId), schemaname, tablename, Convert.ToInt64(ServiceId));
                return PartialView("GLWBHSCPurashkarYojana/_GLWBHSCPurashkarYojanaDocument", GetUploadedDocuments);
            }
            else
            {
                return PartialView("GLWBHSCPurashkarYojana/_GLWBHSCPurashkarYojanaDocument", model);
            }



            //IEnumerable<DocumentDetails> model = await _iglwbhscpurashkaryojanaservice.GetFileDocuments(Convert.ToInt32(ServiceId));
            //return PartialView("GLWBHSCPurashkarYojana/_GLWBHSCPurashkarYojanaDocument", model);

            //DocumentDetails model = await _iglwbhscpurashkaryojanaservice.GetDocumentsDetails(Convert.ToInt32(ServiceId));
            // return PartialView("GLWBHSCPurashkarYojana/_GLWBHSCPurashkarYojanaDocument", model);
        }

        [HttpGet]
        public IActionResult GLWBHSCPurashkarYojanaTermsCondition(string ServiceId, string strApplicationId, bool isFilled)
        {
            int ApplicationId = Convert.ToInt32(strApplicationId);
            ViewBag.ServiceId = ServiceId;
            ViewBag.ApplicationId = ApplicationId;
            ViewBag.TabSequenceNo = 4;
            return PartialView("GLWBHSCPurashkarYojana/_GLWBHSCPurashkarYojanaTermsCondition");
        }
        ...
        {
            var regions = _iglwbhscpurashkaryojanaservice.GetDistrict();
        ...
        {
            var subject = _iglwbhscpurashkaryojanaservice.GetSubject(subjectId);
        ...
        //{
        //    var course = _iglwbhscpurashkaryojanaservice.GetBenifitByCourseId(courseId);
        //    //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        ...
        {
            var regions = _iglwbhscpurashkaryojanaservice.GetTalukaByDistrictId(districtId);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        ...
        {
            var regions = _iglwbhscpurashkaryojanaservice.GetVillageByDistrictIdAndTalukaId(districtId, talukaId);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        ...
        {
            var regions = _iglwbhscpurashkaryojanaservice.GetEducation(nameof(EnumLookup.ResourcesType.Education));
            return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        }
        ...
        public async Task<IActionResult> AddUpdateApplication(GLWBHSC_PersonalDetailsModel personalDetails, string strTabId, string strApplicationNo)
        {
            ...
            personalDetails.schemaname = nameof(EnumLookup.schemaname.glwb_hsc);
            ...
            var regResponse = await _iglwbhscpurashkaryojanaservice.AddUpdateApplication(personalDetails);
            if (regResponse != null)
            {
                ...
                if (regResponse != null && regResponse != null && regResponse.Error == 0)
                {
                    ...
                    return RedirectToAction("GLWBHSCPurashkarYojanaAppPersonalDetails",
                ...
                else
                {
                    ...
                    return RedirectToAction("GLWBHSCPurashkarYojanaAppPersonalDetails", "GLWBHSCPurashkarYojana");
                }
            }
        ...
        public async Task<IActionResult> AddSchemeDetails(GLWBHSCSchemeDetails schemeDetails, int TabSequenceNo, int ApplicationId)
        {
            ...
            schemeDetails.schemaname = nameof(EnumLookup.schemaname.glwb_hsc);
            ...
            var regResponse = await _iglwbhscpurashkaryojanaservice.AddSchemeDetails(schemeDetails);
            return RedirectToAction("GLWBHSCPurashkarYojanaAppPersonalDetails",
                new
                {
        ...
        public async Task<IActionResult> UploadDocument(IList<DocumentDetails.DocumentFileDetails> documentFileDetails, string strTabSequenceNo, string strApplicationId, string strServiceId)
        {
            ...
            if (documentFileDetails != null && documentFileDetails.Count() > 0)
            {
                ...
                foreach (var item in documentFileDetails)
                {
                        ...
                        item.IdImage.File.Length > 0)
                    {
                        ...
                        if (couchDBResponse != null && couchDBResponse.IsSuccess)
                        {
                            ...
                            objdocumentFileDetails.schemaname = nameof(EnumLookup.schemaname.glwb_hsc);
                        ...
                        {
                            return PartialView("GLWBHSCPurashkarYojana/_GLWBHSCPurashkarYojanaDocument");
                        }
                    }
                }
                ...
                var model = await _iglwbhscpurashkaryojanaservice.AddUpdateDocumentDetailsNew(dtData);
            ...
            return RedirectToAction("GLWBHSCPurashkarYojanaAppPersonalDetails", "GLWBHSCPurashkarYojana", documentFileDetails);
        }
        ...
        public async Task<IActionResult> FinalSubmit(FinalSubmitModel finalSubmitModel, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            finalSubmitModel.schemaname = nameof(EnumLookup.schemaname.glwb_hsc);
            ...
            var regResponse = await _iglwbhscpurashkaryojanaservice.FinalSubmit(finalSubmitModel);
            if (regResponse != null)
                if (regResponse != null && regResponse.Error == 0)
                {
                    ...
                    SMSModel modelSMSModel = await _iglwbhscpurashkaryojanaservice.GetSmsContentForService(serviceId, ApplicationId, 1, schemaname, tablename);
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iglwbhscpurashkaryojanaservice.AddSMSLogs(modelSMSModel.MobileNo, serviceId, modelSMSModel.SmsContent, Convert.ToInt32(_claimPincipal.FindFirstValue("RegistrationId")));
                        }
                    }
