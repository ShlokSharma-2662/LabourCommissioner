...
{
    public class GLWBMahilashramLagnaSahayController : Controller
    {
        ...
        private readonly IGLWBMahilashramLagnaSahayService _iGLWBMahilashramLagnaSahayservice;

        public GLWBMahilashramLagnaSahayController(IGLWBMahilashramLagnaSahayService iglwbMahilashramLagnaSahayService, IConfiguration config, IHttpClientFactory clientFactory, IHttpContextAccessor httpContextAccessor, IWebHostEnvironment webHostEnvironment)
        {
            _iGLWBMahilashramLagnaSahayservice = iglwbMahilashramLagnaSahayService ??
                                              throw new ArgumentNullException(nameof(_iGLWBMahilashramLagnaSahayservice));
        ...
        public IActionResult AppPersonalDetails(string strid, string strTabId, string strApplicationId)
        {
            ...
            var model = _iGLWBMahilashramLagnaSahayservice.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_msl), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> PersonalDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            var model = await _iGLWBMahilashramLagnaSahayservice.GetPersonalDetailsByRegNo(RegistrationNo);
            var model1 = await _iGLWBMahilashramLagnaSahayservice.GetApplicationDetailsByAppId(ApplicationId, nameof(EnumLookup.schemaname.glwb_msl), nameof(EnumLookup.tablename.personaldetails));
            ...
            var stateModel = _iGLWBMahilashramLagnaSahayservice.GetAllStates();
            var states = stateModel.Result.ToList();

            ViewBag.States = states;
            ViewBag.isFilled = isFilled;

            var districtModel = _iGLWBMahilashramLagnaSahayservice.GetDistrict();
            ...
            if (isFilled)
            {
                ...
                //var PtalukaModel = _iGLWBMahilashramLagnaSahayservice.GetTalukaByDistrictId(model1.PDistrictId);
                //var Ptaluka = PtalukaModel.Result.ToList();

                //var PvillageModel =
                //    _iGLWBMahilashramLagnaSahayservice.GetVillageByDistrictIdAndTalukaId(model1.PDistrictId, model1.PTalukaId);
                //var Pvillage = PvillageModel.Result.ToList();

                var talukaModel = _iGLWBMahilashramLagnaSahayservice.GetTalukaByDistrictId(model1.CDistrictId);
                var Ctaluka = talukaModel.Result.ToList();

                var villageModel =
                    _iGLWBMahilashramLagnaSahayservice.GetVillageByDistrictIdAndTalukaId(model1.CDistrictId, model1.CTalukaId);
                ...
                return PartialView("GLWBMahilashramLagnaSahay/_GLWBMahilashramLagnaSahayPersonalDetails", model1);
            }

            return PartialView("GLWBMahilashramLagnaSahay/_GLWBMahilashramLagnaSahayPersonalDetails", model);
        ...
        [HttpGet]
        public async Task<IActionResult> GLWBMahilashramLagnaSahaySchemeDetails(string ServiceId, string strApplicationId, bool isFilled)
        {
            long ApplicationId = Convert.ToInt64(strApplicationId);
            ...
            var model1 = await _iGLWBMahilashramLagnaSahayservice.GetApplicationSchemeDetailsByAppId(ApplicationId);
            ViewBag.isFilled = isFilled;

            //var totalsahay = _iGLWBMahilashramLagnaSahayservice.GetTotalsahayByServiceID(serviceId);
            ...
            ViewBag.ApplicationId = ApplicationId;
            return PartialView("GLWBMahilashramLagnaSahay/_GLWBMahilashramLagnaSahaySchemeDetails", model1);
        }

        [HttpGet]
        public async Task<IActionResult> GLWBMahilashramLagnaSahayDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            var model = await _iGLWBMahilashramLagnaSahayservice.GetDocumentFileDetails(Convert.ToInt32(ServiceId), Convert.ToInt32(ApplicationId));


            if (isFilled == true)
            {
                var GetUploadedDocuments = await _iGLWBMahilashramLagnaSahayservice.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.glwb_msl), nameof(EnumLookup.tablename.documentdetails));
                return PartialView("GLWBMahilashramLagnaSahay/_GLWBMahilashramLagnaSahayDocument", GetUploadedDocuments);
            }
            else
            {
                return PartialView("GLWBMahilashramLagnaSahay/_GLWBMahilashramLagnaSahayDocument", model);
            }
        }
        ...
        public IActionResult TermsCondition(string ServiceId, string strApplicationId, bool isFilled)
        {
            ...
            return PartialView("GLWBMahilashramLagnaSahay/_GLWBMahilashramLagnaSahayTermsCondition");
        }
        ...
        {
            var regions = _iGLWBMahilashramLagnaSahayservice.GetDistrict();
        ...
        {
            var regions = _iGLWBMahilashramLagnaSahayservice.GetTalukaByDistrictId(districtId);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        ...
        {
            var regions = _iGLWBMahilashramLagnaSahayservice.GetVillageByDistrictIdAndTalukaId(districtId, talukaId);
            //return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
            return Json(new { data = regions });
        }
        ...
        {
            var regions = _iGLWBMahilashramLagnaSahayservice.GetEducation(nameof(EnumLookup.ResourcesType.Education));
            return Json(regions, System.Web.Mvc.JsonRequestBehavior.AllowGet);
        }
        [HttpPost]
        [ValidateAntiForgeryToken]
        //[PermissionRequirement(PermissionConstant.IsInsert, PermissionConstant.IsUpdate)]
        public async Task<IActionResult> AddUpdateApplication(GLWBMSL_Personaldetails personalDetails, string strTabId, string strApplicationNo)
        {
            ...
            personalDetails.schemaname = nameof(EnumLookup.schemaname.glwb_msl);
            ...
            if (personalDetails.Photo != null && personalDetails.FileName != "" && personalDetails.Photo.Length > 0)
            {
                ...
                else
                {
                    ...
                    return RedirectToAction("AppPersonalDetails", "GLWBMahilashramLagnaSahay", personalDetails);
                }
            }
            ...
            var regResponse = await _iGLWBMahilashramLagnaSahayservice.AddUpdateApplication(personalDetails);
            if (regResponse != null)
            {
                ...
                else
                {
                    ...
                    return RedirectToAction("AppPersonalDetails", "GLWBMahilashramLagnaSahay");
                }
            }
            ...
            return RedirectToAction("GLWBMahilashramLagnaSahaySchemeDetails", "GLWBMahilashramLagnaSahay");
        }

        public async Task<IActionResult> AddSchemeDetails(GLWBMSL_SchemeDetails schemeDetails, int TabSequenceNo, int ApplicationId)
        {
            ...
            schemeDetails.schemaname = nameof(EnumLookup.schemaname.glwb_msl);
            ...
            var regResponse = await _iGLWBMahilashramLagnaSahayservice.AddSchemeDetails(schemeDetails);
            return RedirectToAction("AppPersonalDetails",
        ...
        public async Task<IActionResult> UploadDocument(IList<DocumentFileDetails> documentFileDetails, string strTabSequenceNo, string strApplicationId, string strServiceId)
        {
            ...
            if (documentFileDetails != null && documentFileDetails.Count() > 0)
            {
                ...
                foreach (var item in documentFileDetails)
                {
                        ...
                        item.IdImage.File.Length > 0)
                    {
                        ...
                        {
                            return PartialView("GLWBMahilashramLagnaSahay/_GLWBMahilashramLagnaSahayDocument");
                        }
                    }
                }
                ...
                {
                    responseMessage = await _iGLWBMahilashramLagnaSahayservice.AddUpdateDocumentDetailsNew(dtData);
                }
            ...
            //return View();
            return RedirectToAction("AppPersonalDetails", "GLWBMahilashramLagnaSahay", documentFileDetails);
        }
        ...
        public async Task<IActionResult> FinalSubmit(FinalSubmitModel finalSubmitModel, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            finalSubmitModel.schemaname = nameof(EnumLookup.schemaname.glwb_msl);
            ...
            var regResponse = await _iGLWBMahilashramLagnaSahayservice.FinalSubmit(finalSubmitModel);
            if (regResponse != null)
                if (regResponse != null && regResponse.Error == 0)
                {
                    ...
                    SMSModel modelSMSModel = await _iGLWBMahilashramLagnaSahayservice.GetSmsContentForService(serviceId, ApplicationId, (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.glwb_msl), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iGLWBMahilashramLagnaSahayservice.AddSMSLogs(modelSMSModel.MobileNo, serviceId, modelSMSModel.SmsContent, Convert.ToInt32(_claimPincipal.FindFirstValue("RegistrationId")));
                        }
            ...
            return RedirectToAction("TermsCondition", "GLWBMahilashramLagnaSahay");
        }
