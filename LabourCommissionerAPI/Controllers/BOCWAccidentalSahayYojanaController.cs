...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class BOCWAccidentalSahayYojanaController : ControllerBase
    {
        ...
        //  BOCWAccidentalSahayYojana   bocw_acsy = 6 
        ...
        {
            _iBOCWAccidentalSahayYojanaService = iBOCWAccidentalSahayYojanaService ?? throw new ArgumentNullException(nameof(_iBOCWAccidentalSahayYojanaService));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iBOCWAccidentalSahayYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_acsy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> BOCWAccidentalSahayYojanaSchemeDetail(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] BOCWAcsyCHEMEDETAILSAPI schemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                BOCWACSYSchemeDetails schemeDetails = new BOCWACSYSchemeDetails();
                ...
                var model = await _iBOCWAccidentalSahayYojanaService.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> BOCWAccidentalSahayYojanaDocuments(string ServiceId, string strApplicationId, bool isFilled)
        {
            try
            {
                ...
                var model1 = await _iBOCWAccidentalSahayYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt64(ServiceId), schemaname, tablename);
                if (model1 != null)
                {
                    if (isFilled == true)
                    {
        ...
        public async Task<IActionResult> FinalSubmits([FromBody]FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWAccidentalSahayYojanaService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_acsy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWAccidentalSahayYojanaService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
