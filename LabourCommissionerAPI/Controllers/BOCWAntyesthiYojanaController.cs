...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class BOCWAntyesthiYojanaController : ControllerBase
    {
        ...
        //  BOCWAntyesthiYojana  5   bocw_asy _iBOCWAntyesthiYojanaService
        ...
        {
            _iBOCWAntyesthiYojanaService = iBOCWAntyesthiYojanaService ?? throw new ArgumentNullException(nameof(_iBOCWAntyesthiYojanaService));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iBOCWAntyesthiYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_asy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> BOCWAntyesthiYojanaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        //    try
        //    {
        //        var regions = await _iBOCWAntyesthiYojanaService.GetSubject(subjectId);
        //        if (regions != null)
        //        {
        //            apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        //    try
        //    {
        //        var regions = await _iBOCWAntyesthiYojanaService.GetEducation(nameof(EnumLookup.ResourcesType.Education));
        //        //var subject = await _iBOCWAntyesthiYojanaService.GetSubject(subjectId);
        //        if (regions != null)
        //        {
        //            apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        //            apiResponse.Result = regions;
        ...
        //    try
        //    {
        //        var regions = await _iBOCWAntyesthiYojanaService.GetSemesterbyCourseId(courseid);
        //        if (regions != null)
        //        {
        //            apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        //            apiResponse.Result = regions;
        ...
        //    try
        //    {
        //        var course = await _iBOCWAntyesthiYojanaService.GetBenifitByCourseId(courseId, semesteryear);
        //        if (course != null)
        //        {
        //            apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] BOCWASYSCHEMEDETAILS schemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                BOCWASYSchemeDetails schemeDetails = new BOCWASYSchemeDetails();
                ...
                var model = await _iBOCWAntyesthiYojanaService.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> BOCWAntyesthiYojanaDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            try
            {
                ...
                var schemaname = nameof(EnumLookup.schemaname.bocw_asy);
                var tablename = nameof(EnumLookup.tablename.documentdetails);


                var model1 = await _iBOCWAntyesthiYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt64(ServiceId), schemaname, tablename);
                if (model1 != null)
                {
                    if (isFilled == true)
                    {
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWAntyesthiYojanaService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_asy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWAntyesthiYojanaService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
