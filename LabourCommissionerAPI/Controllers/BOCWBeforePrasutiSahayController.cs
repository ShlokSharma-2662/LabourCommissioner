...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class BOCWBeforePrasutiSahayController : ControllerBase
    {
        ...
        //  BOCWBeforePrasutiSahay   _iBOCWBeforePrasutiSahayService    bocw_psy
        ...
        {
            _iBOCWBeforePrasutiSahayService = iBOCWBeforePrasutiSahayService ?? throw new ArgumentNullException(nameof(_iBOCWBeforePrasutiSahayService));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iBOCWBeforePrasutiSahayService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_psy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> BOCWBeforePrasutiSahaySchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        //    try
        //    {
        //        var regions = await _iBOCWBeforePrasutiSahayService.GetSubject(subjectId);
        //        if (regions != null)
        //        {
        //            apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        //    try
        //    {
        //        var regions = await _iBOCWBeforePrasutiSahayService.GetEducation(nameof(EnumLookup.ResourcesType.Education));
        //        //var subject = await _iBOCWBeforePrasutiSahayService.GetSubject(subjectId);
        //        if (regions != null)
        //        {
        //            apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        //            apiResponse.Result = regions;
        ...
        //    try
        //    {
        //        var regions = await _iBOCWBeforePrasutiSahayService.GetSemesterbyCourseId(courseid);
        //        if (regions != null)
        //        {
        //            apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        //            apiResponse.Result = regions;
        ...
        //    try
        //    {
        //        var course = await _iBOCWBeforePrasutiSahayService.GetBenifitByCourseId(courseId, semesteryear);
        //        if (course != null)
        //        {
        //            apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] BOCWBPSY_SCHEMEDETAILS schemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                ...
                var model = await _iBOCWBeforePrasutiSahayService.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> BOCWBeforePrasutiSahayDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            try
            {
                ...
                var schemaname = nameof(EnumLookup.schemaname.bocw_psy);
                var tablename = nameof(EnumLookup.tablename.documentdetails);


                var model1 = await _iBOCWBeforePrasutiSahayService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt64(ServiceId), schemaname, tablename);
                if (model1 != null)
                {
                    if (isFilled == true)
                    {
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWBeforePrasutiSahayService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_psy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWBeforePrasutiSahayService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
