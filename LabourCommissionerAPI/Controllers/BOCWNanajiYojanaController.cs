...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class BOCWNanajiYojanaController : ControllerBase
    {
        ...
        //  BOCWNanajiYojana   12  bocw_nanji = 13,
        public BOCWNanajiYojanaController(IBOCWNanajiYojanaService iBOCWNanajiYojanaService,
        ...
        {
            _iBOCWNanajiYojanaService = iBOCWNanajiYojanaService ?? throw new ArgumentNullException(nameof(_iBOCWNanajiYojanaService));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iBOCWNanajiYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_nanji), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> BOCWNanajiYojanaSchemeDetail(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] BOCWnanajischemeDetails schemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                BOCWNanjiSchemeDetails schemeDetails = new BOCWNanjiSchemeDetails();
                ...
                if (schemeDetails.lstFamilyMemberDetails != null && schemeDetails.lstFamilyMemberDetails.Count() > 0)
                {
                    ...
                    var model = await _iBOCWNanajiYojanaService.AddSchemeDetails(schemeDetails, dtData);
                    if (model != null)
                    {
                        apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                        apiResponse.Result = model;
        ...
        public async Task<IActionResult> BOCWNanajiYojanaDocuments(string ServiceId, string strApplicationId,bool isFilled)
        {
            try
            {
                ...
                var schemaname = nameof(EnumLookup.schemaname.bocw_nanji);
                var tablename = nameof(EnumLookup.tablename.documentdetails);


                var model1 = await _iBOCWNanajiYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt64(ServiceId), schemaname, tablename);
                if (model1 != null)
                {
                    if (isFilled == true)
                    {
        ...
        public async Task<IActionResult> FinalSubmits([FromBody]FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWNanajiYojanaService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_nanji), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWNanajiYojanaService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
