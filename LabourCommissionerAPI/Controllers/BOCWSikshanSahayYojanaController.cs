...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class BOCWSikshanSahayYojanaController : ControllerBase
    {
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iBOCWSikshanSahayYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_ssy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> BOCWSikshanSahayYojanaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> GetSubject(string subjectId)
        {
            try
            {
                var regions = await _iBOCWSikshanSahayYojanaService.GetSubject(subjectId);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> GetEducation(int schemeType)
        {
            try
            {
                var regions = await _iBOCWSikshanSahayYojanaService.GetEducation(nameof(EnumLookup.ResourcesType.Education));
                //var subject = await _iBOCWSikshanSahayYojanaService.GetSubject(subjectId);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = regions;
        ...
        public async Task<IActionResult> GetSemesterbyCourseId(int courseid)
        {
            try
            {
                var regions = await _iBOCWSikshanSahayYojanaService.GetSemesterbyCourseId(courseid);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = regions;
        ...
        public async Task<IActionResult> GetBenifitByCourseId(int courseId, string semesteryear)
        {
            try
            {
                var course = await _iBOCWSikshanSahayYojanaService.GetBenifitByCourseId(courseId, semesteryear);
                if (course != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] SchemeDetailsAPI schemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                ...
                var model = await _iBOCWSikshanSahayYojanaService.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> BOCWSikshanSahayYojanaDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            try
            {
                ...
                var model1 = await _iBOCWSikshanSahayYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt64(ServiceId), schemaname, tablename);
                if (model1 != null)
                {
                    if (isFilled == true)
                    {
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWSikshanSahayYojanaService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_ssy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWSikshanSahayYojanaService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
