...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class BOCWTabibiSahayYojanaClaimController : ControllerBase
    {
        ...
        //  BOCWTabibiSahayYojanaClaim   12  bocw_tbsy_claim  appli - 1   _iBOCWTabibiSahayYojanaService
        public BOCWTabibiSahayYojanaClaimController(IBOCWTabibiSahayYojanaClaimService iBOCWTabibiSahayYojanaClaimService,
        ...
        {
            _iBOCWTabibiSahayYojanaService = iBOCWTabibiSahayYojanaClaimService ?? throw new ArgumentNullException(nameof(_iBOCWTabibiSahayYojanaService));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iBOCWTabibiSahayYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_tbsy_claim), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> PersonalDetails(string ServiceId, string strApplicationId, bool isFilled, [FromBody] UserCoockiesModel userCoockiesModel)
        {
            try
            {
                var UserName = userCoockiesModel.UserName;
        ...
        public async Task<IActionResult> AddUpdateApplication([FromForm] BOCW_TBSYClaim_personalDetails personalDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabId, string strApplicationNo)
        {
            try
            {
        ...
        public async Task<IActionResult> BOCWTabibiSahayYojanaClaimSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
        ...
        //public async Task<IActionResult> AddSchemeDetails([FromBody] IList<BOCW_TBSYClaim_personalDetails> schemeDetails, int TabSequenceNo, int ApplicationId)
        public async Task<IActionResult> AddSchemeDetails([FromForm] IList<BOCW_TBSYClaim_personalDetails> schemeDetails)
        {
            try
            {
