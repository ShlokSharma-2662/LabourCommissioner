...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class BOCWTabibiSahayYojanaController : ControllerBase
    {
        ...
        //  BOCWTabibiSahayYojana   12  bocw_tbsy  appli - 1   _iBOCWTabibiSahayYojanaService
        ...
        {
            _iBOCWTabibiSahayYojanaService = iBOCWTabibiSahayYojanaService ?? throw new ArgumentNullException(nameof(_iBOCWTabibiSahayYojanaService));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iBOCWTabibiSahayYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_tbsy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> BOCWTabibiSahayYojanaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> GetSubject(string subjectId)
        {
            try
            {
                var regions = await _iBOCWTabibiSahayYojanaService.GetSubject(subjectId);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> GetEducation(int schemeType)
        {
            try
            {
                var regions = await _iBOCWTabibiSahayYojanaService.GetEducation(nameof(EnumLookup.ResourcesType.Education));
                //var subject = await _iBOCWTabibiSahayYojanaService.GetSubject(subjectId);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = regions;
        ...
        public async Task<IActionResult> GetSemesterbyCourseId(int courseid)
        {
            try
            {
                var regions = await _iBOCWTabibiSahayYojanaService.GetSemesterbyCourseId(courseid);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = regions;
        ...
        public async Task<IActionResult> GetBenifitByCourseId(int courseId, string semesteryear)
        {
            try
            {
                var course = await _iBOCWTabibiSahayYojanaService.GetBenifitByCourseId(courseId, semesteryear);
                if (course != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] BOCWtbsySCHEMEDETAILS schemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                BOCWTBSYSchemeDetails schemeDetails = new BOCWTBSYSchemeDetails();
                ...
                var model = await _iBOCWTabibiSahayYojanaService.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> BOCWTabibiSahayYojanaDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            try
            {
                ...
                var schemaname = nameof(EnumLookup.schemaname.bocw_tbsy);
                var tablename = nameof(EnumLookup.tablename.documentdetails);


                var model1 = await _iBOCWTabibiSahayYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt64(ServiceId), schemaname, tablename);
                if (model1 != null)
                {
                    if (isFilled == true)
                    {
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWTabibiSahayYojanaService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_tbsy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWTabibiSahayYojanaService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
