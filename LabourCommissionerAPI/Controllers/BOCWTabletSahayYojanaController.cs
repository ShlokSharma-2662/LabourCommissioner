...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class BOCWTabletSahayYojanaController : ControllerBase
    {
        ...
        //  BOCWTabletSahayYojana   bocw_tsy  8  appli - 7 _iBOCWTabletSahayYojanaService
        ...
        {
            _iBOCWTabletSahayYojanaService = iBOCWTabletSahayYojanaService ?? throw new ArgumentNullException(nameof(_iBOCWTabletSahayYojanaService));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iBOCWTabletSahayYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_tsy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> BOCWTabletSahayYojanaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> GetSubject(string subjectId)
        {
            try
            {
                var regions = await _iBOCWTabletSahayYojanaService.GetSubject(subjectId);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> GetEducation(int schemeType)
        {
            try
            {
                var regions = await _iBOCWTabletSahayYojanaService.GetEducation(nameof(EnumLookup.ResourcesType.Education));
                //var subject = await _iBOCWTabletSahayYojanaService.GetSubject(subjectId);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = regions;
        ...
        public async Task<IActionResult> GetSemesterbyCourseId(int courseid)
        {
            try
            {
                var regions = await _iBOCWTabletSahayYojanaService.GetSemesterbyCourseId(courseid);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = regions;
        ...
        public async Task<IActionResult> GetBenifitByCourseId(int courseId, string semesteryear)
        {
            try
            {
                var course = await _iBOCWTabletSahayYojanaService.GetBenifitByCourseId(courseId, semesteryear);
                if (course != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] BOCWtsySCHEMEDETAILS schemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                BOCWTSYSchemeDetails schemeDetails = new BOCWTSYSchemeDetails();
                ...
                var model = await _iBOCWTabletSahayYojanaService.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> BOCWTabletSahayYojanaDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            try
            {
                ...
                var schemaname = nameof(EnumLookup.schemaname.bocw_tsy);
                var tablename = nameof(EnumLookup.tablename.documentdetails);


                var model1 = await _iBOCWTabletSahayYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt64(ServiceId), schemaname, tablename);
                if (model1 != null)
                {
                    if (isFilled == true)
                    {
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWTabletSahayYojanaService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_tsy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWTabletSahayYojanaService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
