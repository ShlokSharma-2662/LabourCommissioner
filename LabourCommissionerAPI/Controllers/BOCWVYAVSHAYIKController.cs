...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class BOCWVYAVSHAYIKController : ControllerBase
    {
        ...
        // BOCWVYAVSHAYIK bocw_vr  11 appli - 1
        ...
        {
            _iBOCWVYAVSHAYIKService = iBOCWVYAVSHAYIKService ?? throw new ArgumentNullException(nameof(_iBOCWVYAVSHAYIKService));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iBOCWVYAVSHAYIKService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_vr), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> BOCWVYAVSHAYIKSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> GetSubject(string subjectId)
        {
            try
            {
                var subject = await _iBOCWVYAVSHAYIKService.GetSubject(subjectId);
                if (subject != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        [HttpGet("GetDieases")]
        public async Task<IActionResult> GetDieases(long type)
        {
            try
            {
                ...
                if (regions != null)
                {
                    ...
                    apiResponse.Status = EnumLookup.GetDescription(EnumLookup.Status.Success);
                    apiResponse.Message = EnumLookup.GetDescription(EnumLookup.Message.Dieases_Display);
                    apiResponse.StackTrace = null;
                }
                else
                {
                    ...
                    apiResponse.Result = null;
                    apiResponse.Status = EnumLookup.GetDescription(EnumLookup.Status.Not_Found);
                    apiResponse.Message = EnumLookup.GetDescription(EnumLookup.Message.No_Dieases_Display);
                    apiResponse.StackTrace = null;
                }
        ...
        public async Task<IActionResult> GetSemesterbyCourseId(int courseid)
        {
            try
            {
                var regions = await _iBOCWVYAVSHAYIKService.GetSemesterbyCourseId(courseid);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = regions;
        ...
        public async Task<IActionResult> GetBenifitByCourseId(int courseId, string semesteryear)
        {
            try
            {
                var course = await _iBOCWVYAVSHAYIKService.GetBenifitByCourseId(courseId, semesteryear);
                if (course != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] BOCWvrSCHEMEDETAILS schemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                BOCWVRSchemeDetails schemeDetails = new BOCWVRSchemeDetails();
                ...
                if (schemeDetails.lstOtherSchemeDetails != null && schemeDetails.lstOtherSchemeDetails.Count() > 0)
                {
                    ...
                    var model = await _iBOCWVYAVSHAYIKService.AddSchemeDetails(schemeDetails, dtOtherSchemeData);
                    if (model != null)
                    {
                        apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                        apiResponse.Result = model;
        ...
        public async Task<IActionResult> BOCWVYAVSHAYIKDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            try
            {
                ...
                var schemaname = nameof(EnumLookup.schemaname.bocw_vr);
                var tablename = nameof(EnumLookup.tablename.documentdetails);


                var model1 = await _iBOCWVYAVSHAYIKService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt64(ServiceId), schemaname, tablename);
                if (model1 != null)
                {
                    if (isFilled == true)
                    {
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWVYAVSHAYIKService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_vr), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWVYAVSHAYIKService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
