...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class BOCWVishishtaCoachingYojanaController : ControllerBase
    {
        ...
        //  BOCWVishishtaCoachingYojana    bocw_vcy = 9 
        public BOCWVishishtaCoachingYojanaController(IBOCWVishishtaCoachingYojanaService iBOCWVishishtaCoachingYojanaService,
        ...
        {
            _iBOCWVishishtaCoachingYojanaService = iBOCWVishishtaCoachingYojanaService ?? throw new ArgumentNullException(nameof(_iBOCWVishishtaCoachingYojanaService));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iBOCWVishishtaCoachingYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.bocw_vcy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> BOCWVishishtaCoachingYojanaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> GetSubject(string subjectId)
        {
            try
            {
                var regions = await _iBOCWVishishtaCoachingYojanaService.GetSubject(subjectId);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> GetEducation(int schemeType)
        {
            try
            {
                var regions = await _iBOCWVishishtaCoachingYojanaService.GetEducation(nameof(EnumLookup.ResourcesType.Education));
                //var subject = await _iBOCWVishishtaCoachingYojanaService.GetSubject(subjectId);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = regions;
        ...
        public async Task<IActionResult> GetSemesterbyCourseId(int courseid)
        {
            try
            {
                var regions = await _iBOCWVishishtaCoachingYojanaService.GetSemesterbyCourseId(courseid);
                if (regions != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = regions;
        ...
        public async Task<IActionResult> GetBenifitByCourseId(int courseId, string semesteryear)
        {
            try
            {
                var course = await _iBOCWVishishtaCoachingYojanaService.GetBenifitByCourseId(courseId, semesteryear);
                if (course != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] BOCWvcySchemeDetails schemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                BOCWVCYSchemeDetails schemeDetails = new BOCWVCYSchemeDetails();
                ...
                var model = await _iBOCWVishishtaCoachingYojanaService.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> BOCWVishishtaCoachingYojanaDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            try
            {
                ...
                var schemaname = nameof(EnumLookup.schemaname.bocw_vcy);
                var tablename = nameof(EnumLookup.tablename.documentdetails);


                var model1 = await _iBOCWVishishtaCoachingYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt64(ServiceId), schemaname, tablename);
                if (model1 != null)
                {
                    if (isFilled == true)
                    {
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            ...
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iBOCWVishishtaCoachingYojanaService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.bocw_vcy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iBOCWVishishtaCoachingYojanaService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
