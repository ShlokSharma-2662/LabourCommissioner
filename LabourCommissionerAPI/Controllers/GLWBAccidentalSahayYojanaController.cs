...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class GLWBAccidentalSahayYojanaController : ControllerBase
    {
        ...
        public GLWBAccidentalSahayYojanaController(IGLWBAccidentalSahayYojanaService iGLWBAccidentalSahayYojanaservice,
        ...
        {
            _iGLWBAccidentalSahayYojanaservice = iGLWBAccidentalSahayYojanaservice ?? throw new ArgumentNullException(nameof(_iGLWBAccidentalSahayYojanaservice));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iGLWBAccidentalSahayYojanaservice.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_asy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> GLWBAccidentalSahayYojanaPersonalDetails(string ServiceId, string strApplicationId, bool isFilled, [FromBody] UserCoockiesModel userCoockiesModel)
        {
            try
            {
        ...
        public async Task<IActionResult> AddUpdateApplication([FromForm] GLWBASY_PersonalDetailsModel personalDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabId)
        {
            try
            {
        ...
        public async Task<IActionResult> GLWBAccidentalSahayYojanaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] GLWBASY_SchemedetailsAPI glwbPSYSchemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                GLWBASYSchemeDetails schemeDetails = new GLWBASYSchemeDetails();
                ...
                var model = await _iGLWBAccidentalSahayYojanaservice.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> GLWBAccidentalSahayYojanaDocument(string ServiceId, string strApplicationId)
        {
            try
            {
                string ApplicationId = strApplicationId;
                var model = await _iGLWBAccidentalSahayYojanaservice.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.glwb_asy), nameof(EnumLookup.tablename.documentdetails));
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> UploadDocument([FromForm] IList<DocumentFileDetails> documentFileDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabSequenceNo, string strApplicationId, string strServiceId)
        {
            ...
            if (documentFileDetails != null && documentFileDetails.Count() > 0)
            {
                ...
                try
                {
                    ...
                    {
                        responseMessage = await _iGLWBAccidentalSahayYojanaservice.AddUpdateDocumentDetailsNew(dtData);
                    }
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iGLWBAccidentalSahayYojanaservice.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.glwb_asy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iGLWBAccidentalSahayYojanaservice.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
