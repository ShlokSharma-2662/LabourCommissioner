...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class GLWBCycleYojnaController : ControllerBase
    {
        ...
        public GLWBCycleYojnaController(IGLWBCycleYojnaService iGLWBCycleYojnaservice,
        ...
        {
            _iGLWBCycleYojnaservice = iGLWBCycleYojnaservice ?? throw new ArgumentNullException(nameof(_iGLWBCycleYojnaservice));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iGLWBCycleYojnaservice.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_csy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> GLWBCycleYojnaPersonalDetails(string ServiceId, string strApplicationId, bool isFilled, [FromBody] UserCoockiesModel userCoockiesModel)
        {
            try
            {
        ...
        public async Task<IActionResult> AddUpdateApplication([FromForm] GLWBCycle_personalDetails personalDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabId)
        {
            try
            {
        ...
        public async Task<IActionResult> GLWBCycleYojnaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] GLWBCYCLE_SchemedetailsAPI glwbPSYSchemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                GLWBCYCLE_Schemedetails schemeDetails = new GLWBCYCLE_Schemedetails();
                schemeDetails = glwbPSYSchemeDetailsAPI.schemeDetails;
                ...
                schemeDetails.CreatedBy = Convert.ToInt32(glwbPSYSchemeDetailsAPI.userCoockiesModel.RegistrationId);
                ...
                var model = await _iGLWBCycleYojnaservice.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> GLWBCycleYojnaDocument(string ServiceId, string strApplicationId)
        {
            try
            {
                string ApplicationId = strApplicationId;
                var model = await _iGLWBCycleYojnaservice.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.glwb_csy), nameof(EnumLookup.tablename.documentdetails));
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
                ...
                foreach (var item in documentFileDetails)
                {
                        ...
                        item.IdImage.File.Length > 0)
                    {
                        ...
                        if (couchDBResponse != null && couchDBResponse.IsSuccess)
                        {
                            ...
                            objdocumentFileDetails.schemaname = nameof(EnumLookup.schemaname.glwb_csy);
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iGLWBCycleYojnaservice.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.glwb_csy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iGLWBCycleYojnaservice.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
