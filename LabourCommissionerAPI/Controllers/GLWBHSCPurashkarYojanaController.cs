...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class GLWBHSCPurashkarYojanaController : ControllerBase
    {
        ...
        public GLWBHSCPurashkarYojanaController(IGLWBHSCPurashkarYojanaService iGLWBHSCPurashkarYojanaService,
        ...
        {
            _iGLWBHSCPurashkarYojanaService = iGLWBHSCPurashkarYojanaService ?? throw new ArgumentNullException(nameof(_iGLWBHSCPurashkarYojanaService));
        ...
        public async Task<IActionResult> GLWBHSCPurashkarYojanaAppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iGLWBHSCPurashkarYojanaService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_hsc), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> GLWBHSCPurashkarYojanaPersonalDetails(string ServiceId, string strApplicationId, bool isFilled, [FromBody] UserCoockiesModel userCoockiesModel)
        {
            try
            {
        ...
        public async Task<IActionResult> AddUpdateApplication([FromForm] GLWBHSC_PersonalDetailsModel personalDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabId)
        {
            try
            {
        ...
        public async Task<IActionResult> GLWBHSCPurashkarYojanaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] GLWBHSCSchemeDetailsAPI glwbHSCSchemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                GLWBHSCSchemeDetails schemeDetails = new GLWBHSCSchemeDetails();
                schemeDetails = glwbHSCSchemeDetailsAPI.schemeDetails;
                ...
                schemeDetails.CreatedBy = Convert.ToInt32(glwbHSCSchemeDetailsAPI.userCoockiesModel.RegistrationId);
                ...
                var model = await _iGLWBHSCPurashkarYojanaService.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> GLWBHSCPurashkarYojanaDocument(string ServiceId, string strApplicationId)
        {
            try
            {
                ...
                var model = await _iGLWBHSCPurashkarYojanaService.GetUploadedDocuments(Convert.ToInt64(ApplicationId), schemaname, tablename, Convert.ToInt64(ServiceId));
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> UploadDocument([FromForm] IList<DocumentFileDetails> documentFileDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabSequenceNo, string strApplicationId, string strServiceId)
        {
            ...
            if (documentFileDetails != null && documentFileDetails.Count() > 0)
            {
                ...
                try
                {
                    ...
                    {
                        responseMessage = await _iGLWBHSCPurashkarYojanaService.AddUpdateDocumentDetailsNew(dtData);
                    }
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iGLWBHSCPurashkarYojanaService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.glwb_hsc), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iGLWBHSCPurashkarYojanaService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
