...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class GLWBHomeLoanSubsidyYojanaController : ControllerBase
    {
        ...
        public GLWBHomeLoanSubsidyYojanaController(IGLWBHomeLoanSubsidyYojanaService iGLWBHomeLoanSubsidyYojanaservice,
        ...
        {
            _iGLWBHomeLoanSubsidyYojanaservice = iGLWBHomeLoanSubsidyYojanaservice ?? throw new ArgumentNullException(nameof(_iGLWBHomeLoanSubsidyYojanaservice));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iGLWBHomeLoanSubsidyYojanaservice.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_hls), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> GLWBHomeLoanSubsidyYojanaPersonalDetails(string ServiceId, string strApplicationId, bool isFilled, [FromBody] UserCoockiesModel userCoockiesModel)
        {
            try
            {
        ...
        public async Task<IActionResult> AddUpdateApplication([FromForm] GLWBHLS_PersonalDetailsModel personalDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabId)
        {
            try
            {
        ...
        public async Task<IActionResult> GLWBHomeLoanSubsidyYojanaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] GLWBHLS_SchemedetailsAPI glwbPSYSchemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                GLWBHLS_SchemeDetails schemeDetails = new GLWBHLS_SchemeDetails();
                ...
                var model = await _iGLWBHomeLoanSubsidyYojanaservice.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> GLWBHomeLoanSubsidyYojanaDocument(string ServiceId, string strApplicationId)
        {
            try
            {
                string ApplicationId = strApplicationId;
                var model = await _iGLWBHomeLoanSubsidyYojanaservice.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.glwb_hls), nameof(EnumLookup.tablename.documentdetails));
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
                ...
                foreach (var item in documentFileDetails)
                {
                        ...
                        item.IdImage.File.Length > 0)
                    {
                        ...
                        if (couchDBResponse != null && couchDBResponse.IsSuccess)
                        {
                            ...
                            objdocumentFileDetails.schemaname = nameof(EnumLookup.schemaname.glwb_hls);
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iGLWBHomeLoanSubsidyYojanaservice.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.glwb_hls), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iGLWBHomeLoanSubsidyYojanaservice.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
