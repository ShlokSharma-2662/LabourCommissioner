...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class GLWBLaptopSubsidyYojnaController : ControllerBase
    {
        ...
        // glwb_lsy = 30,  GLWBLaptopSubsidyYojna
        public GLWBLaptopSubsidyYojnaController(IGLWBLaptopSubsidyYojnaService iGLWBLaptopSubsidyYojnaservice,
        ...
        {
            _iGLWBLaptopSubsidyYojnaservice = iGLWBLaptopSubsidyYojnaservice ?? throw new ArgumentNullException(nameof(_iGLWBLaptopSubsidyYojnaservice));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iGLWBLaptopSubsidyYojnaservice.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_lsy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> GLWBLaptopSubsidyYojnaPersonalDetails(string ServiceId, string strApplicationId, bool isFilled, [FromBody] UserCoockiesModel userCoockiesModel)
        {
            try
            {
        ...
        public async Task<IActionResult> AddUpdateApplication([FromForm] GLWBLSY_PersonalDetails personalDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabId)
        {
            try
            {
        ...
        public async Task<IActionResult> GLWBLaptopSubsidyYojnaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] GLWBLSY_SchemeDetailsAPI glwblsySchemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                GLWBLSY_SchemeDetails schemeDetails = new GLWBLSY_SchemeDetails();
                schemeDetails = glwblsySchemeDetailsAPI.schemeDetails;
                ...
                schemeDetails.CreatedBy = Convert.ToInt32(glwblsySchemeDetailsAPI.userCoockiesModel.RegistrationId);
                ...
                var model = await _iGLWBLaptopSubsidyYojnaservice.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> GLWBLaptopSubsidyYojnaDocument(string ServiceId, string strApplicationId)
        {
            try
            {
                string ApplicationId = strApplicationId;
                var model = await _iGLWBLaptopSubsidyYojnaservice.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.glwb_lsy), nameof(EnumLookup.tablename.documentdetails));
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
                ...
                foreach (var item in documentFileDetails)
                {
                        ...
                        item.IdImage.File.Length > 0)
                    {
                        ...
                        if (couchDBResponse != null && couchDBResponse.IsSuccess)
                        {
                            ...
                            objdocumentFileDetails.schemaname = nameof(EnumLookup.schemaname.glwb_lsy);
        ...
        public async Task<IActionResult> FinalSubmit([FromBody] FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iGLWBLaptopSubsidyYojnaservice.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.glwb_lsy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iGLWBLaptopSubsidyYojnaservice.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
