...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class GLWBMahilashramLagnaSahayController : ControllerBase
    {
        ...
        public GLWBMahilashramLagnaSahayController(IGLWBMahilashramLagnaSahayService iglwbMahilashramLagnaSahayService,
        ...
        {
            _iGLWBMahilashramLagnaSahayservice = iglwbMahilashramLagnaSahayService ?? throw new ArgumentNullException(nameof(_iGLWBMahilashramLagnaSahayservice));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iGLWBMahilashramLagnaSahayservice.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_msl), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> GLWBMahilashramLagnaSahayPersonalDetails(string ServiceId, string strApplicationId, bool isFilled, [FromBody]UserCoockiesModel userCoockiesModel)
        {
            try
            {
        ...
        public async Task<IActionResult> AddUpdateApplication([FromForm] GLWBMSL_Personaldetails personalDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabId)
        {
            try
            {
        ...
        public async Task<IActionResult> GLWBMahilashramLagnaSahaySchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] GLWBMSL_SchemeDetailsAPI glwbMSLSchemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        {
            try
            {
                GLWBMSL_SchemeDetails schemeDetails = new GLWBMSL_SchemeDetails();
                schemeDetails = glwbMSLSchemeDetailsAPI.schemeDetails;
                ...
                schemeDetails.CreatedBy = Convert.ToInt32(glwbMSLSchemeDetailsAPI.userCoockiesModel.RegistrationId);
                ...
                var model = await _iGLWBMahilashramLagnaSahayservice.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> GLWBMahilashramLagnaSahayDocument(string ServiceId, string strApplicationId)
        {
            try
            {
                string ApplicationId = strApplicationId;               
                var model = await _iGLWBMahilashramLagnaSahayservice.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.glwb_msl), nameof(EnumLookup.tablename.documentdetails));
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
                ...
                foreach (var item in documentFileDetails)
                {
                        ...
                        item.IdImage.File.Length > 0)
                    {
                        ...
                        if (couchDBResponse != null && couchDBResponse.IsSuccess)
                        {
                            ...
                            objdocumentFileDetails.schemaname = nameof(EnumLookup.schemaname.glwb_msl);
        ...
        public async Task<IActionResult> FinalSubmit([FromBody]FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iGLWBMahilashramLagnaSahayservice.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.glwb_msl), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iGLWBMahilashramLagnaSahayservice.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
