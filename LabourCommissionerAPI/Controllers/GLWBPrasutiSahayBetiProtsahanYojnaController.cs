...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class GLWBPrasutiSahayBetiProtsahanYojnaController : ControllerBase
    {
        ...
        public GLWBPrasutiSahayBetiProtsahanYojnaController(IGLWBPrasutiSahayBetiProtsahanYojnaService iglwbprasutisahaybetiprotsahanyojnaservice,
        ...
        {
            _iglwbprasutisahaybetiprotsahanyojnaservice = iglwbprasutisahaybetiprotsahanyojnaservice ?? throw new ArgumentNullException(nameof(_iglwbprasutisahaybetiprotsahanyojnaservice));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iglwbprasutisahaybetiprotsahanyojnaservice.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_psy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> GLWBPrasutiSahayBetiProtsahanYojnaPersonalDetails(string ServiceId, string strApplicationId, bool isFilled, [FromBody]UserCoockiesModel userCoockiesModel)
        {
            try
            {
        ...
        public async Task<IActionResult> AddUpdateApplication([FromForm] GLWBPSY_PersonalDetailsModel personalDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabId)
        {
            try
            {
        ...
        public async Task<IActionResult> GLWBPrasutiSahayBetiProtsahanYojnaSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        public async Task<IActionResult> AddSchemeDetails([FromBody] GLWBPSY_SchemeDetailsAPI glwbPSYSchemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        
         {
            try
            {
                GLWBPSY_SchemeDetails schemeDetails = new GLWBPSY_SchemeDetails();
                ...
                var model = await _iglwbprasutisahaybetiprotsahanyojnaservice.AddSchemeDetails(schemeDetails);
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> GLWBPrasutiSahayBetiProtsahanYojnaDocument(string ServiceId, string strApplicationId)
        {
            try
            {
                string ApplicationId = strApplicationId;               
                var model = await _iglwbprasutisahaybetiprotsahanyojnaservice.GetUploadedDocuments(Convert.ToInt64(ApplicationId), Convert.ToInt32(ServiceId), nameof(EnumLookup.schemaname.glwb_psy), nameof(EnumLookup.tablename.documentdetails));
                if (model != null)
                {
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = model;
        ...
        public async Task<IActionResult> FinalSubmit([FromBody]FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iglwbprasutisahaybetiprotsahanyojnaservice.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.glwb_psy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iglwbprasutisahaybetiprotsahanyojnaservice.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
