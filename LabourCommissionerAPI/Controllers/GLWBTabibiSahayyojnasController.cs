...
namespace LabourCommissionerAPI.Controllers
{
    ...
    public class GLWBTabibiSahayyojnasController : ControllerBase
    {
        ...
        public GLWBTabibiSahayyojnasController(IGLWBTabibiSahayService iGLWBTabibiSahayService,
        ...
        {
            _iGLWBTabibiSahayService = iGLWBTabibiSahayService ?? throw new ArgumentNullException(nameof(_iGLWBTabibiSahayService));
        ...
        public async Task<IActionResult> AppPersonalDetails(int ApplicationId, int id, string schemaname, string tablename)
        {
            try
            {
                var model = await _iGLWBTabibiSahayService.GetTabSequenceByApplicationId(ApplicationId, id, nameof(EnumLookup.schemaname.glwb_tsy), nameof(EnumLookup.tablename.tabentry));
        ...
        public async Task<IActionResult> GLWBTabibiSahayyojnasPersonalDetails(string ServiceId, string strApplicationId, bool isFilled, [FromBody]UserCoockiesModel userCoockiesModel)
        {
            try
            {
                ...
                else if (!isFilled)
                {
                    ...
                    var model = await _iGLWBTabibiSahayService.GetPersonalDetailsByRegNo(RegistrationNo);
        ...
        public async Task<IActionResult> AddUpdateApplication([FromForm] GLWB_TSY_personalDetails personalDetails, [FromForm] UserCoockiesModel userCoockiesModel, string strTabId, string strApplicationNo)
        {
            //try
            //{
        ...
        public async Task<IActionResult> GLWBTabibiSahayyojnasSchemeDetails(string ServiceId, string strApplicationId)
        {
            try
            {
                long ApplicationId = Convert.ToInt64(strApplicationId);
        ...
        //public async Task<IActionResult> AddSchemeDetails([FromBody] GLWBTSY_SchemeDetailsAPI glwbTSYSchemeDetailsAPI, int TabSequenceNo, int ApplicationId)
        //{
        //    try
        //    {
        //        GLWBTSYSchemeDetails schemeDetails = new GLWBTSYSchemeDetails();
        //        schemeDetails = glwbTSYSchemeDetailsAPI.schemeDetails;
        ...
        //        schemeDetails.CreatedBy = Convert.ToInt32(glwbTSYSchemeDetailsAPI.userCoockiesModel.RegistrationId);
        ...
        //        var model = await _iGLWBTabibiSahayService.AddSchemeDetails(schemeDetails);
        //        if (model != null)
        //        {
        //            apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
        //            apiResponse.Result = model;
        ...
        public async Task<IActionResult> GLWBTabibiSahayyojnasDocument(string ServiceId, string strApplicationId, bool isFilled)
        {
            try
            {
                ...
                else if (isFilled)
                {
                    ...
                    apiResponse.StatusCode = (int)EnumLookup.StatusCode.Sucess;
                    apiResponse.Result = GetUploadedDocuments;
                    apiResponse.Status = EnumLookup.GetDescription(EnumLookup.Status.Success);
                    apiResponse.Message = EnumLookup.GetDescription(EnumLookup.Message.Get_DocumentDetails);
                    apiResponse.StackTrace = null;
                }
        ...
        public async Task<IActionResult> FinalSubmit([FromBody]FinalSubmitAPI finalSubmitAPI, string strApplicationId, string strServiceId, string strTabSequenceNo)
        {
            try
            {
                ...
                if (regResponse != null)
                {
                    ...
                    SMSModel modelSMSModel = await _iGLWBTabibiSahayService.GetSmsContentForService(Convert.ToInt64(strServiceId), Convert.ToInt64(strApplicationId), (int)EnumLookup.smstype.AppRequested, nameof(EnumLookup.schemaname.glwb_tsy), nameof(EnumLookup.tablename.personaldetails));
                    if (modelSMSModel != null)
                    {
                        ...
                        if (isSendSMS)
                        {
                            await _iGLWBTabibiSahayService.AddSMSLogs(modelSMSModel.MobileNo, Convert.ToInt64(strServiceId), modelSMSModel.SmsContent, Convert.ToInt32(finalSubmitAPI.userCoockiesModel.RegistrationId));
                        }
